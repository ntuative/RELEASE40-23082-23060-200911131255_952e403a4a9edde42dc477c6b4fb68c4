package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_993:String = "_TITLE";
      
      private static const const_992:String = "_CONTENT";
      
      private static const const_990:String = "_HEADER";
      
      private static const const_991:String = "_SCALER";
      ...
      private var var_1043:IHeaderWindow;
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_236);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_214);
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1043 == null)
         {
            var_1043 = findChildByTag(const_990) as IHeaderWindow;
            if(!var_1043)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_993) as ITextWindow;
            if(!_title)
            {
      ...
      {
         return findChildByTag(const_991) as IScalerWindow;
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_33 == null)
         {
            var_33 = findChildByTag(const_992) as IWindowContainer;
            if(!var_33)
            {
