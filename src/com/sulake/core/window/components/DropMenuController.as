package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow
   {
      ...
      protected static const const_326:String = "_DROPMENU_TITLETEXT";
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         {
            var_123 = context.create(name + "::submenu","",WindowType.const_370,var_86,0 | 0,_loc1_,subMenuEventProc,null,0,null,["_EXCLUDE"]) as DropMenuController;
         }
         else
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.const_89)
         {
            ...
            {
               if(param2.testStateFlag(WindowState.const_71))
               {
         ...
         else if(param1.type == WindowEvent.const_888)
         {
            if(param2 == var_123)
            {
               closeMenuView();
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_395,var_86,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_313,var_86,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         ...
         if(var_418 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(var_418).setStateFlag(WindowState.const_45,true);
         }
      }
      ...
      protected function openMenuView() : void
      {
         if(!var_492)
         {
            if(open())
            {
               if(false)
               {
                  populateMenuItemContainer(var_419,getSubMenu(),subMenuEventProc);
                  var_492 = true;
               }
            }
         }
      ...
      {
         return getChildByName(DropMenuController.const_326) as ITextWindow;
      }
      ...
      protected function closeMenuView() : void
      {
         if(close())
         {
            ...
            var_492 = false;
            getTitleText().text = var_418 < var_419.length && var_418 > -1 ? "null" : caption;
         }
      }
   }
}
