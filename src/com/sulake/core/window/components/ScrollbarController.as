package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1083:String = "increment";
      
      private static const const_485:String = "slider_bar";
      
      private static const const_1084:String = "decrement";
      ...
      {
         return getChildByName(ScrollbarController.const_761) as WindowController;
      }
      ...
      {
         return track.getChildByName(ScrollbarController.const_485) as WindowController;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               var_837 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_837 != null)
         {
            _loc1_ = findParentByName(var_837) as IScrollableWindow;
            if(_loc1_ == null && var_23 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_23).findChildByName(var_837) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(param2.name == ScrollbarController.const_1083)
            {
               if(var_35)
               {
                  var_557 = true;
            ...
            else if(param2.name == ScrollbarController.const_1084)
            {
               if(var_35)
               {
                  var_557 = true;
         ...
         if(param1.type == WindowMouseEvent.const_804)
         {
