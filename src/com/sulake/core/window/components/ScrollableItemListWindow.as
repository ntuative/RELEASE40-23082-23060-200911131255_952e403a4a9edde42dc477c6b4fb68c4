package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_316:IScrollbarWindow;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_316)
         {
            var_316 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(var_316)
            {
               var_316.addEventListener(WindowEvent.const_258,scrollBarEventProc);
               var_316.addEventListener(WindowEvent.const_178,scrollBarEventProc);
            }
         }
         return var_316;
      }
      ...
      override public function dispose() : void
      {
         if(var_316)
         {
            var_316.removeEventListener(WindowEvent.const_258,scrollBarEventProc);
            var_316.removeEventListener(WindowEvent.const_178,scrollBarEventProc);
            var_316 = null;
         }
         if(_cachedItemList)
         {
