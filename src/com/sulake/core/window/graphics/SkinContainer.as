package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      protected static var var_350:Array;
      
      private static const const_996:uint = 8;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         TypeCodeTable.fillTables(var_1302,var_1551);
         var_1049 = new Dictionary();
         var_1550 = new Dictionary();
         StateCodeTable.fillTables(var_1049,var_1550);
         var_420 = new Dictionary();
         var_420["skin"] = BitmapSkinRenderer;
         var_420["bitmap"] = BitmapDataRenderer;
         var_420["fill"] = FillSkinRenderer;
         var_420["text"] = TextSkinRenderer;
         var_420["shape"] = ShapeSkinRenderer;
         var_420["unknown"] = SkinRenderer;
         var_420["null"] = NullSkinRenderer;
         if(var_350 == null)
         {
            var_350 = new Array();
            var_350.push(WindowState.const_58);
            var_350.push(WindowState.const_66);
            var_350.push(WindowState.const_82);
            var_350.push(WindowState.const_45);
            var_350.push(WindowState.const_71);
            var_350.push(WindowState.const_68);
            var_350.push(WindowState.const_81);
            var_350.push(WindowState.const_78);
         }
         var _loc3_:Array = new Array();
         for(_loc4_ in var_1049)
         {
            _loc3_.push(var_1049[_loc4_]);
         }
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc18_ < _loc6_)
               {
                  ...
                  addSkinRenderer(var_1302[_loc9_],uint(_loc10_),_loc15_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         var _loc3_:Array = var_493[param1];
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer) : void
      {
         if(true)
         {
            var_493[param1] = new Array(SkinContainer.const_996);
         }
         var_493[param1][param2] = param3;
      }
      ...
      public function dispose() : void
      {
         ...
         {
            ISkinRenderer(var_493[_loc1_]).dispose();
