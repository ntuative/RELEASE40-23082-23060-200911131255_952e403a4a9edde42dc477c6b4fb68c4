package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_972:uint = 256;
      
      protected static var var_575:uint = 0;
      
      protected static var var_351:uint = 0;
      
      public static const const_768:uint = 2;
      
      public static const const_1526:uint = 128;
      
      public static const const_1508:uint = 64;
      
      public static const const_527:uint = 4;
      
      public static const const_1329:uint = 0;
      
      public static const const_1219:uint = 16;
      
      public static const const_544:uint = 1;
      
      public static const const_1300:uint = 8;
         ...
         if(var_570)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1501,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1501,16777215);
                  }
                  var_351 += bitmap.width * bitmap.height * 4;
               }
