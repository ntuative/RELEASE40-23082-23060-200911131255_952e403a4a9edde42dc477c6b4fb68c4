package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_920:String = "_EXCLUDE";
      
      public static const const_1532:String = "_TEMP";
      
      private static const const_997:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_998:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      protected var var_851:Dictionary;
      
      protected var var_1274:Map;
      
      protected var _context:IWindowContext;
      
      protected var var_1275:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(var_1023,var_1022);
         var_851 = new Dictionary();
         var_1275 = new Dictionary();
         ParamCodeTable.fillTables(var_851,var_1275);
         var_1274 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_998,"");
         return param1.replace(const_997,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            ...
            for(_loc1_ in var_851)
            {
               delete var_851[_loc1_];
            }
            for(_loc1_ in var_1275)
            {
               delete var_1275[_loc1_];
            }
            var_1274.dispose();
            var_1274 = null;
            _context = null;
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_920) == -1)
                  {
