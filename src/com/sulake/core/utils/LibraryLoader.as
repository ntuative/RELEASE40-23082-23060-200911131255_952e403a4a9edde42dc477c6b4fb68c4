package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1546:int = 5;
      
      protected static const const_1015:uint = 7;
      
      protected static const const_1347:uint = 4;
      
      protected static const const_1346:uint = 3;
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         if(var_411 == LibraryLoader.const_1346)
         {
            if(analyzeLibrary())
            {
               var_411 |= 0;
         ...
         if(var_411 == LibraryLoader.const_1015)
         {
            var_1287 = true;
            prepareLibrary();
            removeEventListeners();
