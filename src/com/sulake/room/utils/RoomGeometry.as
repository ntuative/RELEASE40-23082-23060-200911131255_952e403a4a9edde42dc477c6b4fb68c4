package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      private var var_1392:Number = 1;
      
      private var var_2211:Number = 500;
      ...
      private var var_2210:Number = -500;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         _y = new Vector3d();
         var_90 = new Vector3d();
         var_951 = new Vector3d();
         var_1390 = 1;
         var_1391 = 1;
         x_scale = 1;
         y_scale = 1;
         var_1392 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:* = 0;
         var_220.assign(param1);
         if(var_220.x != _loc2_ || var_220.y != _loc3_ || var_220.z != _loc4_)
         {
            ++var_82;
         }
      ...
      {
         if(var_376 != param1 * var_1392)
         {
            var_376 = param1 * var_1392;
            ++var_82;
         }
      }
      ...
      {
         if(var_375 != param1 * var_1390)
         {
            var_375 = param1 * var_1390;
            ++var_82;
         }
      }
      ...
      {
         if(var_378 != param1 * var_1391)
         {
            var_378 = param1 * var_1391;
            ++var_82;
         }
      }
      ...
      {
         return new Vector3d(var_220.x,var_220.y,var_220.z);
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_951.assign(_loc22_);
         }
         else
         {
            var_951.assign(_loc17_);
         }
         ++var_82;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_378;
         _loc2_.z *= var_376;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_951);
         if(_loc3_ < var_2210 || _loc3_ > var_2211)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_378;
            _loc2_.z *= var_376;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_951);
         }
      ...
      {
         return new Vector3d(0 * var_375,0 * var_378,0 * var_376);
      }
      ...
      {
         return scale == const_546;
      }
      
      public function get scale() : Number
      {
         return var_204 / Math.sqrt(0.5);
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc5_:Number = param1.x / var_204;
         var _loc6_:Number = -param1.y / var_204;
         var _loc7_:IVector3d = Vector3d.sum(Vector3d.product(var_89,_loc5_),Vector3d.product(_y,_loc6_));
         var _loc8_:Vector3d = new Vector3d(0 * var_375,0 * var_378,0 * var_376);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_90;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_375,param2.y * var_378,param2.z * var_376);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_375,param3.y * var_378,param3.z * var_376);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_375,param4.y * var_378,param4.z * var_376);
