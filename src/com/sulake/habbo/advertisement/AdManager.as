package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1939:BitmapData = null;
      ...
      private var var_1938:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_422,0,0,_loc4_,var_1428,var_1938,var_1939));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_1935 = int(_config.getKey("interstitial.interval","30000"));
         var_1936 = int(_config.getKey("interstitial.show.time","5000"));
         var_1429 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1193 = _loc2_.imageUrl;
         var_1428 = _loc2_.clickUrl;
         if(var_1193 != "" && var_1428 != "")
         {
            _loc3_ = var_1193;
            ...
            _loc4_ = new URLRequest(var_1193);
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         var_1194 = _loc2_.imageUrl;
         var_1937 = _loc2_.clickUrl;
         var_658 = getTimer();
         if(var_1194 != "")
         {
            _loc3_ = var_1194;
            ...
            var_227.start();
            _loc4_ = new URLRequest(var_1194);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_355,0,0,param1.bitmapData,var_1937));
            var_658 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1939 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1429 > 0 && var_1427 >= var_1429)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_658;
         if(_loc1_ > var_1935)
         {
            ++var_1427;
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1938 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
