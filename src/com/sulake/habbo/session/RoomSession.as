package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_921:UserDataManager;
      ...
      {
         if(_state == RoomSessionEvent.const_310 && _connection != null)
         {
      ...
      {
         return var_921 as IUserDataManager;
      }
