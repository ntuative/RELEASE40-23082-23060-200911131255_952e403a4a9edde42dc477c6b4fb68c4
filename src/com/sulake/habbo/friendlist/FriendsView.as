package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      {
         var_1971 = initButton("open_minimail",onMinimailButtonClick,param1);
         var_1968 = initButton("open_homepage",onHomeButtonClick,param1);
         var_1970 = initButton("room_invite",onInviteButtonClick,param1);
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_340.setData(_loc3_.online,_loc3_.name,_loc3_.motto,_loc3_.figure,_loc3_.lastAccess,_loc3_.realName);
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1971,isEnableMinimailButton(_loc1_));
         setEnabled(var_1968,isEnableHomeButton(_loc1_));
         setEnabled(var_1970,isEnableInviteButton(_loc1_));
