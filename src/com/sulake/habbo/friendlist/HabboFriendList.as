package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1719:IAvatarRenderManager;
      ...
      private var var_831:FriendRequests;
      ...
      private var var_2056:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_361:FriendListTabs;
      
      private var var_2055:IHabboNotifications;
      ...
      {
         var_2056 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_309 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1474 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1473 == null)
         {
            var_1473 = new OpenedToWebPopup(this);
         }
         var_1473.show(x,y);
      }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_831.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_831.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_361.findTab(FriendListTab.const_92).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(var_831.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_831 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.method_14);
         for each(_loc3_ in _loc2_.categories)
         {
            var_309.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_309.addCategory(new FriendCategory(FriendCategory.const_800,getText("friendlist.friends")));
         var_309.addCategory(new FriendCategory(FriendCategory.const_458,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_309.addFriend(new Friend(_loc4_));
         }
         var_361 = new FriendListTabs(new FriendListTabsDeps(this));
         _loc5_ = new Timer(120000);
         _loc5_.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
         _loc5_.start();
         getBuddyRequests();
         registerListeners();
         var_195.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_113,HabboToolbarIconEnum.FRIENDLIST));
      ...
      {
         var _loc2_:IAvatarImage = var_1719.createAvatarImage(param1,AvatarScaleType.const_99);
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1719 = param2 as IAvatarRenderManager;
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_831.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_361.findTab(FriendListTab.const_92);
      ...
      {
         var_2055 = param2 as IHabboNotifications;
      ...
      {
         var _loc1_:String = var_179.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_361.findSelectedTab();
            if(_loc1_ == null)
            {
      ...
      {
         return var_179.getKey(param1,param1,param2);
      }
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1474.searchReceived(_loc2_.friends,_loc2_.others);
