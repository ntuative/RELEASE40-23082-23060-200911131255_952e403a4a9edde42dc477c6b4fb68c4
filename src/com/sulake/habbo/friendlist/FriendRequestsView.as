package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_293 && _loc4_.state != FriendRequest.const_285)
            {
      ...
      {
         var_1388 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1389 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1389.procedure = onDismissAllButtonClick;
         var_1388.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      private function onDeclineButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc4_.state = FriendRequest.const_285;
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_285)
         {
            _friendList.refreshText(_loc2_,"info_text",true,"${friendlist.request.declined}");
         }
         else if(param1.state == FriendRequest.const_894)
         {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1388,_loc1_);
         setEnabled(var_1389,_loc1_);
      }
