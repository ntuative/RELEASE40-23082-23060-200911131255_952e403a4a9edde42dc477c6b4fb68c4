package com.sulake.habbo.friendlist
{
   ...
   public class AvatarPopupCtrl extends PopupCtrl
   {
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         if(var_1157 != "")
         {
            friendList.refreshText(param1,"name_text_online",var_618,var_1157);
         }
         else
         {
            friendList.refreshText(param1,"name_text_online",var_618,var_1367);
         }
         friendList.refreshText(param1,"name_text_offline",!var_618,var_1367);
         friendList.refreshText(param1,"motto_text",var_618,var_1758);
         friendList.refreshButton(param1,"offline",!var_618,null,0);
         if(var_618)
         {
            refreshFigure(param1,var_1757);
