package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1444:int = "F".charCodeAt(0);
      
      public static const const_1490:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         var_562 = param1.figure;
         var_1156 = param1.motto;
         var_1155 = param1.lastAccess;
         var_1137 = param1.categoryId;
         var_1157 = param1.realName;
