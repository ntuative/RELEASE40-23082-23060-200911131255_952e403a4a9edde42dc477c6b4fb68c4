package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialClothesChangeView implements ITutorialUIView
   {
      ...
      public function TutorialClothesChangeView(param1:IItemListWindow, param2:TutorialUI)
      {
         ...
         var_53.help.toolbar.events.addEventListener(HabboToolbarShowMenuEvent.const_47,onShowMenuEvent);
      ...
      private function windowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param2.name)
         {
            case "button_cancel":
               ...
               {
                  var_53.showView(TutorialUI.const_83);
               }
         }
      }
      ...
      private function onShowMenuEvent(param1:HabboToolbarShowMenuEvent) : void
      {
         if(param1.menuId == HabboToolbarIconEnum.MEMENU && param1.type == HabboToolbarShowMenuEvent.const_47)
         {
            ...
            hideToolbarIconHighlightArrow();
            var_53.help.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_465));
         }
      }
      ...
      private function showToolbarIconHighlightArrow() : void
      {
         ...
         var_499 = var_53.buildXmlWindow("tutorial_arrow") as IWindowContainer;
         var _loc1_:IBitmapWrapperWindow = var_499.findChildByName("arrow") as IBitmapWrapperWindow;
         if(_loc1_ != null)
         {
         ...
         var_53.help.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_47,HabboToolbarIconEnum.MEMENU_ARROW,var_499));
      }
      
      public function dispose() : void
      {
         setToolbarIconHighlight(false);
         var_53.help.toolbar.events.removeEventListener(HabboToolbarShowMenuEvent.const_47,onShowMenuEvent);
      }
   }
}
