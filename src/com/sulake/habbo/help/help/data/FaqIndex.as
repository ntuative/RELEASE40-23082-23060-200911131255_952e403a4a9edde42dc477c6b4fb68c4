package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_613:FaqCategory;
      ...
      {
         super();
         var_612 = new FaqCategory(-999,"${help.faq.title.urgent}");
         _frontPageNormal = new FaqCategory(-9999,"${help.faq.title.normal}");
         var_613 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
         var_131 = new Map();
      }
      ...
      public function storeAnswerText(param1:int, param2:String) : void
      {
         ...
         if(var_613.hasItem(param1))
         {
            var_613.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
