package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private static const const_1352:int = 0;
      ...
      private var var_1570:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","23082-23060-200911131228");
         var_195 = param5;
         var_112 = new Map();
         var_112.add(HabboHelpViewEnum.const_1230,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_112.add(HabboHelpViewEnum.const_130,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_112.add(HabboHelpViewEnum.const_413,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_112.add(HabboHelpViewEnum.const_256,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_112.add(HabboHelpViewEnum.const_201,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_112.add(HabboHelpViewEnum.const_642,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_112.add(HabboHelpViewEnum.const_272,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_112.add(HabboHelpViewEnum.const_622,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_112.add(HabboHelpViewEnum.const_213,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary)));
         var_112.add(HabboHelpViewEnum.CALL_FOR_HELP_PENDING_ITEM,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_112.add(HabboHelpViewEnum.const_579,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_240 == HabboHelpViewEnum.const_130 || false)
         {
            return;
         }
         if(var_355 == null)
         {
            ...
            var_355 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
         }
         var _loc1_:IItemListWindow = _window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || var_355 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(var_355 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(var_355 as IWindow);
      ...
      {
         return var_112.getValue(var_240);
      }
      ...
      {
         var_1569 = param1;
         var _loc2_:IHelpViewController = var_112.getValue(HabboHelpViewEnum.const_130) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_213:
               ...
               break;
            case CallForHelpResultEnum.const_892:
      ...
      {
         var _loc3_:* = null;
         if(var_240 == HabboHelpViewEnum.const_130)
         {
            return;
         }
         if(true)
         {
            ...
            var_496.push(_loc3_.content as BitmapData);
            _loc3_ = _assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            var_496.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = var_355.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(var_496[1],var_496[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(var_496[0],var_496[0].rect,new Point(0,0));
         }
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1305;
         _window.width = _loc1_.width + var_1306;
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + var_240);
            return;
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_42.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_698));
      }
