package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, ICoreUpdateReceiver
   {
      ...
      private var var_404:IHabboHelp;
      
      private var var_1259:LagWarningLogger = null;
      
      private var var_841:IHabboWindowManager;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1251,Capabilities.serverString);
      ...
      {
         var_179 = IHabboConfigurationManager(param2);
         if(var_179)
         {
            Component(var_179).events.addEventListener(HabboConfigurationEvent.const_25,onConfigurationLoaded);
            if(var_233 != null)
            {
               var_233.configuration = var_179;
            }
            if(var_232 != null)
            {
               var_232.configuration = var_179;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_474.events.addEventListener(AdEvent.const_422,onRoomAdLoad);
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_179)
            {
               var_179.release(new IIDHabboConfigurationManager());
               var_179 = null;
            }
            if(_localization)
            {
            ...
            if(var_841)
            {
               var_841.release(new IIDHabboWindowManager());
               var_841 = null;
            }
            if(var_474)
            {
            ...
            if(var_178)
            {
               if(true)
               {
                  Component(var_178).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,onFriendlistTrackingEvent);
                  Component(var_178).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,onFriendlistTrackingEvent);
                  Component(var_178).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,onFriendlistTrackingEvent);
                  Component(var_178).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,onFriendlistTrackingEvent);
                  Component(var_178).events.removeEventListener(HabboFriendListTrackingEvent.const_318,onFriendlistTrackingEvent);
               }
               var_178.release(new IIDHabboFriendList());
               var_178 = null;
            }
            if(var_404)
            {
               if(true)
               {
                  var_404.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
                  var_404.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
               }
               var_404.release(new IIDHabboHelp());
               var_404 = null;
            }
            if(_roomEngine)
            {
               if(true)
               {
                  Component(_roomEngine).events.removeEventListener(AvatarWalkWarpingWarningEvent.const_416,onLagWarningEvent);
               }
            }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_655,onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_631,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_61,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_351,onHotelViewEvent);
      }
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_416:
               var_1259.registerWarning(LagWarningLogger.const_778);
         }
      }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_179)
         {
            Component(var_179).events.removeEventListener(HabboConfigurationEvent.const_25,onConfigurationLoaded);
         }
      }
      ...
      {
         var_404 = param2 as IHabboHelp;
         var_404.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
         var_404.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
      }
      ...
      {
         var_841 = IHabboWindowManager(param2);
         if(var_841)
         {
      ...
      {
         if(var_179 != null && Boolean(var_179.getKey("processlog.enabled") == false))
         {
            return;
         }
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(AvatarWalkWarpingWarningEvent.const_416,onLagWarningEvent);
         Component(_roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_218,onRoomAdClick);
      }
      ...
      {
         var_178 = param2 as IHabboFriendList;
         Component(var_178).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,onFriendlistTrackingEvent);
         Component(var_178).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,onFriendlistTrackingEvent);
         Component(var_178).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,onFriendlistTrackingEvent);
         Component(var_178).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,onFriendlistTrackingEvent);
         Component(var_178).events.addEventListener(HabboFriendListTrackingEvent.const_318,onFriendlistTrackingEvent);
      }
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         var _loc8_:* = null;
         var _loc9_:int = 0;
         if(param1.critical && !var_2098)
         {
            var_2098 = true;
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1218,new Date().getTime().toString());
            if(var_179)
            {
               if(var_179.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = var_179.getKey("client.fatal.error.url");
      ...
      private function onHotelViewEvent(param1:Event) : void
      {
         ...
         else if(param1.type == HabboHotelViewEvent.const_351)
         {
