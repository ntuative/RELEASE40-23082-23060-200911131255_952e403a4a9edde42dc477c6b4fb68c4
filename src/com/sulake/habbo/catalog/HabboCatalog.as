package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog
   {
      ...
      private var var_593:PurchaseConfirmationDialog;
      ...
      {
         return var_491.getProductData(param1);
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         updatePurse();
         if(!var_1669 && var_826 != null)
         {
            var_826.playSound(HabboSoundTypesEnum.const_803);
         }
         var_1669 = false;
      }
      ...
      {
         return var_491.getFurnitureData(param1);
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "true" == var_179.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = var_179.getKey("link.format.credits");
               if(_loc3_ != "")
               {
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_86:
               var_1081 = param1.session.isPrivateRoom;
               if(var_88 != null)
               {
      ...
      private function createCatalogNavigator() : void
      {
         ...
         var_359 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      public function showPurchaseConfirmation(param1:Offer, param2:ICatalogPage, param3:String = "") : void
      {
         ...
         else
         {
            if(var_593 == null)
            {
               var_593 = new PurchaseConfirmationDialog(_localization);
            }
            var_593.showOffer(this,param1,param2,param3);
         }
      }
      ...
      public function openCatalogPage(param1:String, param2:Boolean = false) : void
      {
         ...
         {
            toggleCatalog(true);
            var_359.openPage(param1);
         }
      }
      
      private function setHabboToolbarIcon() : void
      {
         var_195.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_113,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         var_359.buildCatalogIndex(_loc2_);
         if(var_902 != "")
         {
            var_359.openPage(var_902);
            var_902 = "";
         }
         else
         {
            var_359.openFrontPage();
         }
      }
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         if(param2.type == WindowEvent.const_190)
         {
            _loc3_ = var_179.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               _windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,onExternalLink);
               navigateToURL(new URLRequest(_loc3_),"habboMain");
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         updatePurse();
         if(!var_1670 && var_826 != null)
         {
            var_826.playSound(HabboSoundTypesEnum.const_933);
         }
         var_1670 = false;
      }
