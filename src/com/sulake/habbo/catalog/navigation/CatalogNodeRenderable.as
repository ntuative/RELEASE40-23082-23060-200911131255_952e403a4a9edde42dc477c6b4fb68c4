package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1043:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1395:XML;
      
      private static var var_1393:XML;
      ...
      private var var_1394:Number = 4.294967295E9;
      ...
      public function CatalogNodeRenderable(param1:ICatalogNavigator, param2:NodeData, param3:int)
      {
         ...
         if(var_1393 == null)
         {
            ...
            var_1393 = _loc4_.content as XML;
         }
      }
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(var_1394 == 4294967295)
            {
               var_1394 = _loc1_.color;
            }
            _loc1_.color = const_1043;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1229;
            }
         }
      }
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            _window = navigator.catalog.windowManager.buildFromXML(var_1395) as IWindowContainer;
         }
         else
         {
      ...
      {
         _list = navigator.catalog.windowManager.buildFromXML(var_1393) as IItemListWindow;
         if(_list == null)
         {
