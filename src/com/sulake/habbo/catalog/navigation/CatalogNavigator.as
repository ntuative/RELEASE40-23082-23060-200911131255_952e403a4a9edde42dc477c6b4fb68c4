package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2201:String = "magic.pixels";
      
      private var var_2203:String = "catalog.page.club";
      
      private var var_2202:String = "magic.credits";
      ...
      {
         var_84.openCatalogPage(var_2203,true);
      }
      ...
      public function activateNode(param1:ICatalogNode) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         var _loc2_:* = var_239.indexOf(param1) > -1;
         var _loc3_:Boolean = param1.isOpen;
         var _loc4_:* = [];
         for each(_loc5_ in var_239)
         {
            _loc5_.deActivate();
         ...
         {
            _loc6_.close();
            _loc7_ = var_239.indexOf(_loc6_);
            var_239.splice(_loc7_,1);
         }
         param1.activate();
         if(_loc2_ && _loc3_)
         {
