package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog
   {
         ...
         switch(_loc2_)
         {
            case "button_ok":
               if(var_558)
               {
                  ...
                  HabboCatalog(var_84).purchaseProduct(var_650,var_176,var_1007,true,_loc5_,_loc6_);
               }
               else
               {
                  HabboCatalog(var_84).purchaseProduct(var_650,var_176,var_1007);
               }
               dispose();
               break;
            case "button_cancel":
      ...
      private function showDialog() : void
      {
         ...
         if(_window == null)
         {
            _window = var_84.windowManager.createWindow("OrderInfo","${catalog.purchase.confirmation.dialog.title}",HabboWindowType.const_320,HabboWindowStyle.const_39,0 | 0 | 0,new Rectangle(10,10,300,180),null) as IFrameWindow;
         }
         else
         {
         ...
         if(_loc4_)
         {
            ...
            _loc17_.addEventListener(WindowEvent.const_556,onDeActivateGift);
            _loc17_.addEventListener(WindowEvent.const_588,onActivateGift);
         }
         _window.center();
         ...
         var _loc11_:IProductData = var_84.getProductData(var_176.localizationId);
