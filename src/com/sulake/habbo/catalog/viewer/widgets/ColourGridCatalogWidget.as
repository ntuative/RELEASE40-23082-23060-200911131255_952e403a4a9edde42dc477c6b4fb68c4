package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function init() : void
      {
         ...
         var_1148 = _loc1_.content as XML;
      ...
      private function populateColourGrid() : void
      {
         ...
         var_278 = null;
         for each(_loc1_ in var_1150)
         {
            _loc2_ = page.viewer.catalog.windowManager.buildFromXML(var_1148) as IWindowContainer;
            ...
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(var_1149.width,var_1149.height,true,0);
               _loc6_ = 255;
               _loc7_ = 255;
               _loc8_ = 255;
               if(_loc1_ > 0)
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_943.width,var_943.height,true,16777215);
               _loc5_.bitmap.copyPixels(var_943,var_943.rect,new Point(0,0),null,null,true);
