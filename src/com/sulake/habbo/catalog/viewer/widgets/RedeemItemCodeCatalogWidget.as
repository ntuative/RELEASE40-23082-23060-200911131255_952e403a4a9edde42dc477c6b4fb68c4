package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1002:IButtonWindow;
      ...
      override public function dispose() : void
      {
         ...
         if(var_1002 != null)
         {
            var_1002.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_1003 != null)
         {
            var_1003.removeEventListener(WindowKeyboardEvent.const_126,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_1002 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_1002 != null)
         {
            var_1002.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_1003 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_1003 != null)
         {
            var_1003.addEventListener(WindowKeyboardEvent.const_126,windowKeyEventProcessor);
         }
      }
