package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(var_373 >= var_280.length)
         {
            return "";
         }
         var petColor:IPetColor = var_280[var_373] as IPetColor;
         var color:uint = petColor.rgb;
         var p:String = _name + String.fromCharCode(10) + addZeroPadding(String(var_1376),3) + String.fromCharCode(10) + addZeroPadding(color.toString(16).toUpperCase(),6);
         return p;
      }
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var_373 = param1.index;
         if(var_373 < 0 || var_373 > var_280.length)
         {
            var_373 = 0;
         }
         updateImage();
      ...
      override public function init() : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_243,onTextWindowEvent);
         var_907 = new Map();
         ...
         var_755 = getPetTypeIndexFromProduct(_loc5_.localizationId);
         var_938 = 0;
         var_280 = [];
         if(page && false && page.viewer.catalog)
         {
            ...
            {
               _loc11_ = _loc10_.avatarRenderManager.petDataManager.getPetData(var_755);
               if(_loc11_)
               {
                  var_938 = _loc11_.breeds.length;
         ...
         var _loc6_:int = 0;
         while(_loc6_ < var_938)
         {
            _loc3_.push(_loc4_.getKey(getRaceLocalizationKey(var_755,_loc6_),getRaceLocalizationKey(var_755,_loc6_)));
            _loc6_++;
         }
         var_907.add(var_755,_loc5_);
      ...
      private function updateImage() : void
      {
         ...
         if(var_373 >= 0 && var_373 < var_280.length)
         {
            _loc6_ = var_280[var_373] as IPetColor;
            if(_loc6_ != null)
            {
               _loc2_ = uint(_loc6_.rgb);
            }
         }
         var _loc3_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImageNew(var_755,var_1376,_loc2_,AvatarScaleType.const_50);
         if(_loc3_ == null)
         {
            return;
         }
         _loc3_.initActionAppends();
         _loc3_.appendAction(AvatarAction.const_277,AvatarAction.const_560);
