package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1180:String = "LandscapeRasterizer";
      ...
      private var _floorType:String = "LandscapeRasterizer";
      ...
      override public function init() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            for each(_loc2_ in page.offers)
            {
               ...
               {
                  case "floor":
                     for each(_loc9_ in var_179.floors.pattern)
                     {
                        var_805.push(String(_loc9_.@id));
                        var_1199.push(_loc2_);
                     }
                     break;
                  case "wallpaper":
                     for each(_loc10_ in var_179.walls.pattern)
                     {
                     ...
                     break;
                  case "landscape":
                     for each(_loc11_ in var_179.landscapes.pattern)
                     {
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(var_976 != null && var_975 != null)
         {
            setRoomImage(var_976,var_975);
         }
      }
      ...
      private function updateConfiguration() : void
      {
         ...
         for each(_loc1_ in var_179.walls.pattern)
         {
            if(_loc1_.@id == _loc2_)
            {
               if(var_229 >= 0)
         ...
         for each(_loc1_ in var_179.floors.pattern)
         {
            if(_loc1_.@id == _loc5_)
            {
         ...
         for each(_loc1_ in var_179.landscapes.pattern)
         {
            if(_loc1_.@id == _loc7_)
            {
               _loc13_ = _loc1_.children()[var_264];
               if(_loc13_ != null)
               {
                  var_1181 = _loc13_.@id;
               }
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_177:
               ...
               var_662 = 0;
               _loc5_ = "null";
               for each(_loc8_ in var_179.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
                     var_662 = _loc8_.children().length();
                  }
               }
            ...
            case const_176:
               ...
               var_663 = 0;
               _loc7_ = "null";
               for each(_loc10_ in var_179.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
                     var_663 = _loc10_.children().length();
                  }
               }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_buy_wall":
               ...
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1180);
               }
               break;
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(_floorType,var_1180,var_1181,64,this,"window_romantic_wide");
