package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1258:IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1201.text = "${" + _loc3_.name + "}";
            var_1200.text = "${" + _loc3_.description + "}";
         }
         else
         {
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_470:
                  _loc4_ = var_1257.clone();
                  if(var_563 != null)
                  {
                     var_563.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_563,var_1258,var_1276);
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_286:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_277,AvatarAction.const_567);
      ...
      {
         var_1201 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1200 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_92 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1483 = new Point(var_92.x,var_92.y);
         var_563 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1258 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_563 == null)
         {
         ...
         var_1257 = _loc2_.content as BitmapData;
