package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public function FurniModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboLocalizationManager, param7:IHabboConfigurationManager)
      {
         ...
         var_444 = new Timer(const_1014,1);
      ...
      {
         return _controller.getSubCategoryViewId() == InventorySubCategory.const_235;
      }
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = var_363.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = var_363.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Boolean = false) : GroupItem
      {
         ...
         else if(param3 == FurniCategory.const_284)
         {
         ...
         if(var_600 == null)
         {
            var_600 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc10_:IWindowContainer = var_600.clone() as IWindowContainer;
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_235:
               ...
               break;
            case InventorySubCategory.const_787:
               removeAllLocks();
               if(_view != null)
               {
                  _view.updateActionView();
         ...
         if(param1 == InventoryCategory.const_77 && false)
         {
            switch(_view.visibleCategoryId)
            {
               ...
               case const_41:
                  ...
                  break;
               case const_271:
                  _controller.toggleInventoryPage(InventoryCategory.const_217);
            }
         }
      }
      ...
      {
         if(var_720 && param1.type == RoomEngineObjectEvent.const_194)
         {
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_284 || _loc3_.category == FurniCategory.const_290 || _loc3_.category == FurniCategory.const_303)
         {
            if(param1)
            {
               return false;
      ...
      {
         return var_363.getValue(param1);
      }
      
      public function clearFurniList() : void
      {
         var_363 = new Map();
         var_363.add(const_40,new Array());
         var_363.add(const_41,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
