package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      public function FurniView(param1:FurniModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboConfigurationManager)
      {
         ...
         _roomEngine = param4;
         var_479 = new Map();
         var_479.add(FurniModel.const_40,new FurniGridView(var_91,FurniModel.const_40,_windowManager,_assetLibrary,_roomEngine));
         var_479.add(FurniModel.const_41,new FurniGridView(var_91,FurniModel.const_41,_windowManager,_assetLibrary,_roomEngine));
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = var_479.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         var _loc4_:FurniGridView = var_479.getValue(var_480);
         if(_loc4_ != null)
         {
      ...
      public function clearViews() : void
      {
         ...
         while(_loc4_ < _loc1_.length)
         {
            ...
            _loc3_ = var_479.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = var_91.getGroupItemInIndex(_loc3_,var_480);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            ...
            else if(_loc5_.category == FurniCategory.const_284)
            {
      ...
      {
         var _loc3_:FurniGridView = var_479.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
