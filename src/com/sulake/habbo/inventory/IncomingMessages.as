package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      public function onFurniListUpdate(param1:IMessageEvent) : void
      {
         ...
         var_28.setInventoryCategoryInit(InventoryCategory.const_77,false);
      }
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         var_28.setInventoryCategoryInit(InventoryCategory.const_652);
         _loc2_.refreshViews();
         var_28.notifyChangedEffects();
      }
      ...
      private function onPets(param1:PetInventoryEvent) : void
      {
         ...
         var_28.setInventoryCategoryInit(InventoryCategory.const_217);
      }
      ...
      public function onFurniList(param1:IMessageEvent) : void
      {
         ...
         var_28.setInventoryCategoryInit(InventoryCategory.const_77);
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         var_28.toggleInventorySubPage(InventorySubCategory.const_235);
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         _loc3_.updateView();
         var_28.setInventoryCategoryInit(InventoryCategory.const_221);
      }
