package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView
   {
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         var_450 = _view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         if(var_501 == null || false)
         {
            method_2();
            return;
         }
         setSelectedGridItem(var_501.getWithIndex(0));
      }
      ...
      {
         var _loc2_:PetsGridItem = var_501.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         var_450.removeGridItem(_loc2_.window);
         if(var_278 == _loc2_)
         {
            var_278 = null;
            selectFirst();
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_501.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            var_450.addGridItem(_loc2_.window);
            var_501.add(param1.id,_loc2_);
            if(var_278 == null)
            {
               selectFirst();
            }
      ...
      private function method_2(param1:PetsGridItem = null) : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc4_:* = null;
