package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_414:uint = 4;
      ...
      public static const const_1307:uint = 9;
      
      public static const const_181:uint = 5;
      ...
      public function updateItemGroupMaps(param1:int, param2:Map, param3:int, param4:Map) : void
      {
         ...
         var_465 = false;
         var_657 = false;
         var_52.updateItemList(var_656);
         var_52.updateItemList(var_1192);
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         else if(param1 is TradingAcceptEvent)
         {
            ...
            {
               var_465 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            {
               var_52.alertPopup(TradingView.const_873);
            }
            close();
         }
      ...
      {
         Logger.log("OLD STATE: " + _state + " NEW STATE: " + param1 + " OWN: " + var_465 + " OTHER: " + var_657);
         ...
         {
            case const_152:
               if(param1 == const_164 || param1 == const_181)
               {
                  _state = param1;
                  _loc2_ = true;
               }
      ...
      {
         var_52.setMinimized(param1 != InventoryCategory.const_77);
      ...
      public function close() : void
      {
         if(var_565)
         {
            if(_state != const_152 && _state != const_181)
            {
               requestCancelTrading();
               state = TradingModel.TRADING_STATE_CANCELLED;
            }
            state = const_152;
            var_28.toggleInventorySubPage(InventorySubCategory.const_787);
            var_565 = false;
         }
         var_52.setMinimized(false);
      }
