package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_757:uint = 4284532064;
      
      private static const const_758:uint = 2577770;
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_950)
            {
            ...
            var_340.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_426);
            var_340.show();
         }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         if(var_1464 == null)
         {
            var_1464 = createMinimizedWindow();
         }
         if(!var_2039)
         {
            return var_67;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(var_67)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_757) : uint(const_758);
            }
