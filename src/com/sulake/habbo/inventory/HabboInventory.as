package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_1552:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(var_34 != null)
         {
            ...
            var_34.events.removeEventListener(RoomSessionEvent.const_90,roomSessionEventHandler);
            var_34.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_402,roomSessionEventHandler);
      ...
      {
         return EffectsModel(var_57.getValue(InventoryCategory.const_652));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_57.getValue(InventoryCategory.const_77));
      }
      ...
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_912));
      }
      
      public function get petsModel() : PetsModel
      {
         return PetsModel(var_57.getValue(InventoryCategory.const_217));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1552);
         }
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_738.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_738.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return TradingModel(var_57.getValue(InventorySubCategory.const_235));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_491 = ISessionDataManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),onConfigurationManagerReady);
      }
      
      public function isInventoryCategoryInit(param1:String) : Boolean
      {
         if(var_738.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1364 = new IncomingMessages(this);
      ...
      {
         return BadgesModel(var_57.getValue(InventoryCategory.const_221));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_34.events.addEventListener(RoomSessionEvent.const_90,roomSessionEventHandler);
         var_34.events.addEventListener(RoomSessionPropertyUpdateEvent.const_402,roomSessionEventHandler);
         ...
         var_57.add(InventoryCategory.const_77,_loc3_);
         var _loc4_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_491);
         var_57.add(InventoryCategory.const_221,_loc4_);
         var _loc5_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_57.add(InventoryCategory.const_652,_loc5_);
         var _loc6_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_491);
         ...
         var_57.add(InventorySubCategory.const_235,_loc7_);
         ...
         var_57.add(InventoryCategory.const_217,_loc9_);
