package com.sulake.habbo.ui
{
   ...
   public class RoomQueueWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionQueueEvent.const_415:
               ...
               {
                  case RoomSessionQueueEvent.const_825:
                     _loc3_ = "null";
                     break;
               ...
               if(_loc5_.length > 1)
               {
                  if(_loc4_ && _loc2_.queueTypes.indexOf(RoomSessionQueueEvent.const_876) != -1)
                  {
                     _loc6_ = _loc2_.getQueueSize(RoomSessionQueueEvent.const_876) + 1;
                     _loc7_ = true;
                  }
                  else
                  {
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetRoomQueueMessage.const_624);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomQueueMessage.const_669:
               _container.roomSession.changeQueue(RoomSessionQueueEvent.const_825);
               break;
            case RoomWidgetRoomQueueMessage.const_624:
               if(false)
               {
                  _container.catalog.openCatalogPage(CatalogPageName.const_299,true);
               }
         }
         return null;
      }
      ...
      {
         return [RoomSessionQueueEvent.const_415];
      }
