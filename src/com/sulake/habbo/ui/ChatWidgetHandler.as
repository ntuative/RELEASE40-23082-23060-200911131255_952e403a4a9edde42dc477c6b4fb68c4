package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_436:Point = null;
      ...
      {
         return [RoomSessionChatEvent.const_128];
      }
      ...
      public function dispose() : void
      {
         ...
         if(var_437 != null)
         {
            ...
            {
               _loc2_ = var_437.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_128:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_437.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_591.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_437.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_591.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_497,RoomWidgetChatSelectAvatarMessage.const_612];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_497:
                  ...
                  if(_loc3_ != null)
                  {
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_128,_container.roomSession,0,"Version 23082-23060-200911131228");
                           ...
                           case ":chooser":
                              ...
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_289);
                     ...
                     switch(_loc3_.chatType)
                     {
                        case RoomWidgetChatMessage.const_106:
                           ...
                           break;
                        case RoomWidgetChatMessage.const_91:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_708 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_708);
            }
            if(var_436 == null)
            {
               var_438.x = 0;
               var_438.y = 0;
               var_438.z = 0;
               var_436 = _loc4_.getScreenPoint(var_438);
               var_708 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_438.x = 0;
            var_438.y = 0;
            var_438.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_438);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_436.x || _loc8_.y != var_436.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_436,_loc5_));
