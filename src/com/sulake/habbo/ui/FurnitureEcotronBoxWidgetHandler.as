package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_534,RoomWidgetEcotronBoxOpenMessage.const_590,RoomWidgetEcotronBoxOpenedMessage.const_1221];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_534:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_590:
