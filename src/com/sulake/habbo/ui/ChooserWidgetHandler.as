package com.sulake.habbo.ui
{
   ...
   public class ChooserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function handleUserChooserRequest() : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetChooserContentEvent(RoomWidgetChooserContentEvent.const_341,_loc3_));
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_289);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_427);
         _loc1_.push(RoomWidgetRoomObjectMessage.const_569);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_427:
               ...
               break;
            case RoomWidgetRequestWidgetMessage.const_289:
               handleUserChooserRequest();
               break;
            case RoomWidgetRoomObjectMessage.const_569:
