   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_465:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_455));
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_552,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_465,onHelpTutorialEvent);
         ...
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_552,onFigureUpdate);
         }
         var_28 = _container.inventory;
         if(var_28 != null)
         {
            (var_28 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_912,onAvatarEffectsChanged);
            (var_28 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_539,onHabboClubSubscriptionChanged);
         }
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_465,onHelpTutorialEvent);
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_538);
         _loc1_.push(RoomWidgetDanceMessage.const_672);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_650);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_586);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_708);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_499);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_625);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_563);
         _loc1_.push(RoomWidgetStopEffectMessage.const_547);
         ...
         _loc1_.push(RoomWidgetToolbarMessage.const_598);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_657);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1215);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_964);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_526);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_653);
         _loc1_.push(RoomWidgetRedeemClubPromoMessage.const_510);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_496);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1225);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_487);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_643);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_653:
               ...
               break;
            case RoomWidgetWaveMessage.const_538:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetDanceMessage.const_672:
               if(_container != null && false)
               {
            ...
            case RoomWidgetGetEffectsMessage.const_650:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_586:
               if(var_28 != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_708:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_563:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(var_84 != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_610)
               {
                  var_84.openCatalogPage(CatalogPageName.const_299,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_625:
               ...
               if(var_28 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_797:
                        var_84.openCatalogPage(CatalogPageName.const_1162,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_903:
                        var_28.toggleInventoryPage(InventoryCategory.const_221);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1252:
                        var_28.toggleInventoryPage(InventoryCategory.const_77);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1118:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_499:
            case RoomWidgetStopEffectMessage.const_547:
               ...
               break;
            case RoomWidgetSetToolbarIconMessage.const_956:
               _loc4_ = param1 as RoomWidgetSetToolbarIconMessage;
               switch(_loc4_.widgetType)
               {
                  case RoomWidgetSetToolbarIconMessage.const_1153:
                     break;
                  default:
            ...
            case RoomWidgetNavigateToRoomMessage.const_954:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_526:
               if(_container != null)
               {
            ...
            case RoomWidgetToolbarMessage.const_676:
               ...
               break;
            case RoomWidgetToolbarMessage.const_598:
               _loc6_ = param1 as RoomWidgetToolbarMessage;
               if(var_195)
               {
                  var_195.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_382,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_657:
               ...
               if(_container)
               {
                  ...
                  if(false && !_loc23_)
                  {
                     ...
                     if(_loc25_ && false)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_354,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_882));
                     }
                     _loc26_ = int(_container.config.getKey("avatar.editor.trial.promo")) > 0;
                     if(_loc26_ && true)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_354,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_1145));
                     }
                  }
               }
               break;
            case RoomWidgetRedeemClubPromoMessage.const_510:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_496:
               ...
               break;
            case RoomWidgetStoreSettingsMessage.const_487:
               _container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_302,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_643:
