package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1553:int = 5;
      
      private const const_1554:int = 5;
      ...
      {
         var _loc2_:* = null;
         if(var_1142 != null && var_1142.indexOf(param1) != -1)
         {
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_754 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_754 += param1.height + const_1554;
            return fit(param1);
         }
         param1.offset(_offsetX,var_754);
         _offsetX += param1.width + const_1553;
         return true;
      }
