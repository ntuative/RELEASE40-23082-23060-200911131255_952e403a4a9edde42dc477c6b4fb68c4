package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1555:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1557:String = "level";
      
      private var var_103:IItemListWindow;
      
      private const const_1558:String = "energy";
      
      private var var_1167:Map;
      
      private const const_1561:String = "nutrition";
      ...
      private const const_1563:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_379:PetCommandTool;
      ...
      {
         if(var_103 == null || var_212 == null || var_65 == null)
         {
            return;
         }
      ...
      private function openTrainView() : void
      {
         if(var_379 == null)
         {
            var_379 = new PetCommandTool(_widget);
         }
         var _loc1_:InfoStandPetData = var_1167.getValue(var_694) as InfoStandPetData;
         if(_loc1_ != null)
         {
            var_379.showWindow(true);
            var_379.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         updateStateElement(const_1557,param1.level,param1.levelMax);
         updateStateElement(const_1556,param1.experience,param1.experienceMax);
         updateStateElement(const_1558,param1.energy,param1.method_3);
         updateStateElement(const_1561,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_694 = param1.id;
         var_1167.remove(param1.id);
         var_1167.add(param1.id,param1);
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         var_379.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1562,const_1563,false);
         ...
         _loc5_.fillRect(_loc7_,const_1555);
         return _loc5_;
      }
