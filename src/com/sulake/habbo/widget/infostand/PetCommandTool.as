package com.sulake.habbo.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private var var_310:IFrameWindow;
      
      private var _widget:InfostandWidget;
      
      private var var_873:Map;
      
      private const const_1547:int = 1100;
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         _widget = param1;
         var_873 = new Map();
         var_238 = new Timer(const_1547);
         var_238.addEventListener(TimerEvent.TIMER,onButtonDisableTimeout);
      }
      ...
      private function updateCommandButtonsViewState(param1:Array) : void
      {
         ...
         do
         {
            ...
            _loc2_ = var_122.findChildByName(_loc4_) as IButtonWindow;
            if(_loc2_ == null)
            {
               break;
            }
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_576,param1);
      ...
      private function openInfoWindow() : void
      {
         ...
         if(var_310 == null)
         {
            ...
            var_310 = (_widget.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(var_310 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            var_310.x = 200;
            var_310.procedure = onInfoWindowProcedure;
         }
         else
         {
      ...
      {
         var _loc2_:Array = var_873.getValue(var_694) as Array;
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_540,var_694,var_1539 + " " + _loc6_);
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc4_:ITextWindow = var_122.findChildByName("pet_name") as ITextWindow;
         if(_loc4_ != null)
         {
            _loc4_.text = param2;
         }
         var _loc5_:IBitmapWrapperWindow = var_122.findChildByName("avatar_image") as IBitmapWrapperWindow;
         if(_loc5_ != null)
         {
         ...
         var _loc6_:Array = var_873.getValue(param1) as Array;
         if(_loc6_ == null)
         {
            updateCommandButtonsViewState(new Array());
            requestEnabledCommands(var_694);
         }
         else
         {
      ...
      private function createCommandWindow() : void
      {
         ...
         var_122 = (_widget.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
         if(var_122 == null)
         {
            throw new Error("Failed to construct command window from XML!");
         }
         var_122.procedure = onCommandWindowProcedure;
         var_122.x = 80;
      }
   }
}
