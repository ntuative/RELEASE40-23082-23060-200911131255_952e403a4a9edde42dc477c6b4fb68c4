      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_)
         {
            case "dance":
               ...
               _widget.changeView(MeMenuWidget.const_788);
               break;
            case "wave":
               if(false)
               {
               ...
               if(false)
               {
                  _widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_783));
            ...
            case "hc":
               ...
               break;
            case "settings":
               _widget.changeView(MeMenuWidget.const_491);
               break;
            default:
