   ...
   public class EffectView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_809 = _window.findChildByName("effect_hilite");
            var_809.visible = false;
         }
         var_810 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_808 = _window.findChildByName("loader_bar");
         if(var_808 != null)
         {
            var_390 = var_808.width;
            var_173.start();
            onUpdate();
         }
         if(false)
