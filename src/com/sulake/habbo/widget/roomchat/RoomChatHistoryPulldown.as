package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      public static const const_193:int = 0;
      
      public static const const_725:int = 3;
      
      private static const const_727:int = 150;
      
      private static const const_726:int = 250;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         var_41 = param3;
         var_1511 = (_assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         var_1293 = (_assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         var_1512 = (_assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         var_1292 = (_assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         var_1294 = (_assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         var_1514 = (_assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         var_1513 = (_assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         var_74 = _windowManager.createWindow("chat_history_bg","",HabboWindowType.BITMAP_WRAPPER,HabboWindowStyle.const_38,HabboWindowParam.const_64,new Rectangle(0,0,param3.width,param3.height - const_70),null,0,0) as IBitmapWrapperWindow;
         var_41.addChild(var_74);
         _window = _windowManager.createWindow("chat_pulldown","",HabboWindowType.const_54,HabboWindowStyle.const_38,HabboWindowParam.const_35,new Rectangle(0,0 - const_70,param3.width,const_70),null,0) as IWindowContainer;
         var_41.addChild(_window);
         var_101 = _windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_360,HabboWindowStyle.const_39,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_70),null,0) as IRegionWindow;
         if(var_101 != null)
         {
            var_101.background = true;
            var_101.alphaTreshold = 0;
            var_101.addEventListener(WindowMouseEvent.const_42,onPulldownMouseDown);
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_449:
               var_74.blend += param1 / const_726;
               _window.blend += param1 / const_726;
               if(false)
               {
                  state = const_283;
               }
               break;
            case const_725:
               var_74.blend = 0 - param1 / const_727;
               _window.blend = 0 - param1 / const_727;
               if(true)
               {
                  state = const_193;
               }
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         {
            var_101.x = 0;
            var_101.y = 0 - const_70;
            var_101.width = 0 - var_1515;
         }
         if(var_74 != null)
         {
            var_74.rectangle = var_41.rectangle;
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(var_1516 == _window.width)
         {
            return;
         }
         var_1516 = _window.width;
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            if(_loc1_.width > 0 && _loc1_.height > 0)
            {
               ...
               tileBitmapHorz(var_1511.clone(),_loc7_);
