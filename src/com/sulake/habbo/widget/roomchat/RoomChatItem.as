package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_1073:Number = 18;
      
      private static const const_1376:Number = 10;
      
      private static const const_1375:Number = 8;
      ...
      {
         _widget.onItemMouseOut(var_997,var_996,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_997,var_996,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1238 = param1.chatType;
         var_997 = param1.userId;
         var_828 = param1.userName;
         var_996 = param1.userCategory;
         _message = param1.text;
         var_1237 = param1.userX;
      ...
      public function renderView() : void
      {
         ...
         switch(var_1238)
         {
            ...
            case RoomWidgetChatUpdateEvent.const_122:
               ...
               break;
            case RoomWidgetChatUpdateEvent.const_91:
               _loc1_ = "bubble_shout";
               break;
            case RoomWidgetChatUpdateEvent.const_246:
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_998 != 0)
            {
               _loc31_ = uint(var_998 >> 16 & 255);
               _loc32_ = uint(var_998 >> 8 & 255);
               _loc33_ = uint(var_998 >> 0 & 255);
            }
         ...
         if(_loc20_ != null)
         {
            if(var_1238 == RoomWidgetChatUpdateEvent.const_246)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_828);
            }
            else if(var_1238 == RoomWidgetChatUpdateEvent.const_228)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_828);
            }
            else
            {
         ...
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_336 + _loc20_.textWidth + const_482;
            _loc38_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_997,var_996,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_997,var_996,_roomId,_roomCategory,param1);
      }
