package com.sulake.habbo.widget.doorbell
{
   ...
   public class DoorbellView
   {
      ...
      public function createMainWindow() : void
      {
         ...
         var_55 = (var_325.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
         if(var_55 == null)
         {
      ...
      private function createListItem(param1:String, param2:int) : IWindow
      {
         ...
         var _loc4_:IWindowContainer = (var_325.windowManager as ICoreWindowManager).buildFromXML(_loc3_.content as XML) as IWindowContainer;
         if(_loc4_ == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
