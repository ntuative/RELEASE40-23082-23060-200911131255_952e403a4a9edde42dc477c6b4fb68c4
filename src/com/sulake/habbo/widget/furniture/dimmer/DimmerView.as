package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_1075:XML;
      
      private var var_373:int;
      
      private var var_435:DimmerViewColorGrid;
      
      private var _window:IWindowContainer;
      
      private var var_1644:int;
      
      private var var_314:DimmerViewAlphaSlider;
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_54,HabboWindowStyle.const_38,0 | 0,new Rectangle(const_988,const_987,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               var_435 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,_widget.windowManager,_widget.assets);
            }
         }
         _loc1_ = _window.findChildByName("brightness_container");
         if(_loc1_ != null)
         {
            var_314 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,_widget.assets);
         }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(var_435 != null)
         {
            var_435.setSelectedColorIndex(param1);
         }
         _widget.previewCurrentSetting();
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(var_314 != null)
         {
            var_314.min = _widget.minLights[param1 - 1];
         }
      }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         selectTab(param1);
         var_899 = _loc2_.light;
         if(var_314 != null)
         {
            var_314.setValue(var_899);
         }
         var_373 = colors.indexOf(_loc2_.color);
         if(var_435 != null)
         {
            var_435.setSelectedColorIndex(var_373);
         }
