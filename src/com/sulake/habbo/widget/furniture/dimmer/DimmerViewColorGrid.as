   ...
   public class DimmerViewColorGrid
   {
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         for each(_loc2_ in colors)
         {
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_804.width,var_804.height,true,0);
      ...
      {
         var _loc2_:int = var_387.getGridItemIndex(param1.target as IWindow);
      ...
      public function setSelectedColorIndex(param1:int) : void
      {
         ...
         if(param1 < 0 || param1 >= var_387.numGridItems)
         {
            return;
         }
         select(var_387.getGridItemAt(param1) as IWindowContainer);
      }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         var_804 = BitmapData(_loc3_.content);
