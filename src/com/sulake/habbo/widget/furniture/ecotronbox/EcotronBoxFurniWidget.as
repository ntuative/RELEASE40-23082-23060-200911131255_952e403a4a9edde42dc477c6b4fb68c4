package com.sulake.habbo.widget.furniture.ecotronbox
{
   ...
   public class EcotronBoxFurniWidget extends RoomWidgetBase
   {
      ...
      {
         var _loc1_:* = null;
         if(var_208 || var_149 == -1 || !_controller)
         {
            return;
         }
         var_208 = true;
         ...
         {
            _loc1_ = new RoomWidgetEcotronBoxOpenMessage(RoomWidgetEcotronBoxOpenMessage.const_590,var_149);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("ecotronboxcardui_container","",HabboWindowType.const_54,HabboWindowStyle.const_38,0 | 0,new Rectangle(const_988,const_987,2,2),null,0) as IWindowContainer;
         ...
         if(_loc6_ != null && var_184 != null)
         {
            _loc6_.caption = var_184;
         }
