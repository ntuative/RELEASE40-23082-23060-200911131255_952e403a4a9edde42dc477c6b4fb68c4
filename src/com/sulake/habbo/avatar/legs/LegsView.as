package com.sulake.habbo.avatar.legs
{
   ...
   public class LegsView implements IAvatarEditorCategoryView
   {
      ...
      public function LegsView(param1:LegsModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_624["null"] = new AvatarEditorGridView(param1,FigureData.const_137,param2,param3);
         var_624["null"] = new AvatarEditorGridView(param1,FigureData.const_149,param2,param3);
         var_624["null"] = new AvatarEditorGridView(param1,FigureData.const_135,param2,param3);
         attachImages();
