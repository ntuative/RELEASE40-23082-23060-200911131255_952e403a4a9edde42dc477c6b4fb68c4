package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1459:Number = 1;
      
      private var _b:uint;
      
      private var var_1460:Number = 1;
      
      private var var_1295:int;
      
      private var _colorTransform:ColorTransform;
      
      private var var_1520:uint;
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1461,var_1460,var_1459,_alphaMultiplier);
         var_867 = generatePaletteMapForGrayscale(var_1520,var_1522);
      }
      
      public function get reds() : Array
      {
         return var_867.getValue("reds") as Array;
      }
      ...
      {
         return var_867.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_867.getValue("greens") as Array;
      }
      ...
      {
         return var_867.getValue("alphas") as Array;
      }
