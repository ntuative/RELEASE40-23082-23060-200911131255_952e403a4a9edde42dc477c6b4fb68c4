package com.sulake.habbo.avatar.structure
{
   ...
   public class AvatarStructureDownload extends EventDispatcher
   {
      ...
      public static const const_866:String = "AVATAR_STRUCTURE_DONE";
       
      
      private var _assets:IAssetLibrary;
      
      private var var_1776:IStructureData;
      
      private var var_262:XML;
      ...
      private function onDataComplete(param1:Event) : void
      {
         ...
         try
         {
            var_262 = new XML(loaderStruct.assetLoader.content as String);
         }
         catch(e:Error)
         {
         ...
         var_1776.append(var_262);
         dispatchEvent(new Event(AvatarStructureDownload.const_866));
      }
   }
}
