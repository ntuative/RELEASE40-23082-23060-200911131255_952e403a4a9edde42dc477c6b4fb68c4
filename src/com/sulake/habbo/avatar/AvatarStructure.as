package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_778:AvatarActionManager;
      
      private var var_157:IAssetLibrary;
      
      private var var_461:FigureData;
      
      private var var_2173:IAssetLibrary;
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1122[param3];
      ...
      {
         return var_778.getActionDefinitionWithState(param1);
      }
      ...
      public function init(param1:IHabboConfigurationManager) : void
      {
         ...
         switch(var_777)
         {
            case AvatarType.const_95:
               ...
               if(!var_461.parse(_loc5_))
               {
                  return;
               }
               var_1410.add(new AvatarStructureDownload(var_157,_loc2_,var_461));
               _loc6_ = true;
               break;
            case AvatarType.PET:
      ...
      {
         return var_778.getCanvasOffsets(param1,param2,param3);
      }
      ...
      {
         return var_778.getActionDefinition(param1);
      }
      
      private function initActions() : void
      {
         var_778 = new AvatarActionManager(var_157,var_777);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
               ...
               if(_loc7_.hasAddData())
               {
                  for each(_loc9_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc12_ = var_381.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_381.getActiveParts(param1.definition);
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int) : Array
      {
         ...
         var _loc6_:ActionDefinition = var_778.getDefaultActionType();
         var _loc7_:Array = var_381.getActiveParts(param3.definition);
         if(param3.definition.isAnimation)
         {
            _loc17_ = param3.definition.state + "." + param3.actionParameter;
            _loc8_ = var_642.getAnimation(_loc17_);
            if(_loc8_ != null)
            {
               ...
               if(_loc25_ != null)
               {
                  ...
                  for each(_loc26_ in _loc25_.parts)
                  {
                     if(_loc9_.indexOf(_loc26_.type) > -1)
                     {
                        ...
                        _loc13_ = var_381.getPartDefinition(_loc26_.type);
         ...
         for each(_loc11_ in _loc9_)
         {
            ...
            if(!_loc33_)
            {
               if(_loc7_.indexOf(_loc11_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_381.getPartDefinition(_loc11_);
                     _loc35_ = false;
                     _loc36_ = 1;
      ...
      private function onStructureReady(param1:Event = null) : void
      {
         ...
         {
            var_381.getPartDefinition("ri").appendToFigure = true;
            var_381.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      {
         return var_778.sortActions(param1);
      }
   }
}
