package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridItem
   {
      ...
      private static var var_80:Array = [];
      ...
      private const const_1548:int = 16777215;
      
      private var _isSelected:Boolean = false;
      
      private var var_1318:BitmapData;
      
      private const const_1549:int = 13421772;
      
      private var var_697:Rectangle;
      ...
      private var var_497:IFigurePartSet;
      ...
      public function AvatarEditorGridItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:IPartColor = null, param5:Boolean = true)
      {
         ...
         if(param3 == null)
         {
            var_344 = new BitmapData(1,1,true,16777215);
         }
         else
         {
            var_886 = param3.isColorable;
         }
         var_886 = param5;
      ...
      {
         var _loc3_:Number = var_80.indexOf(param1.type);
         var _loc4_:Number = var_80.indexOf(param2.type);
         if(_loc3_ < _loc4_)
         {
            return -1;
         }
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            if(var_344 != null)
            {
               _loc2_ = var_344.clone();
               if(_color != null && var_886)
               {
         ...
         if(var_497 != null && false)
         {
            ...
            if(_loc6_ != null)
            {
               ...
               _loc6_.bitmap.copyPixels(var_1318,var_1318.rect,new Point(0,0),null,null,true);
            }
         }
         if(isSelected)
         {
            _window.color = const_1549;
         }
         else
         {
      ...
      private function renderThumb() : BitmapData
      {
         ...
         _loc1_ = new BitmapData(var_697.width,var_697.height,true,16777215);
         for each(_loc2_ in partSet.parts.concat().sort(sortByDrawOrder))
         {
            _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + FigureData.const_908 + "_" + FigureData.const_254;
            ...
            if(_loc4_ != null)
            {
               ...
               if(_color != null && var_886 && _loc2_.isColorable)
               {
      ...
      private function analyzeLayers() : void
      {
         ...
         {
            _loc2_ = "undefined_undefined_" + _loc1_.type + "_" + _loc1_.id + "_" + FigureData.const_908 + "_" + FigureData.const_254;
