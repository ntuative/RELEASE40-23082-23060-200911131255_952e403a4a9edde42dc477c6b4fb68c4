package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private var var_1304:PaletteManager;
      
      private var var_690:CoreComponent;
      
      private var var_1303:ILogger;
      
      private var var_1051:PetDataManager;
      ...
      {
         var _loc2_:* = null;
         _loc2_ = var_494.getValue(AvatarType.const_95) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      {
         return var_1051 as IPetDataManager;
      }
      ...
      {
         var _loc3_:AvatarStructure = var_494.getValue(AvatarType.const_95) as AvatarStructure;
         if(_loc3_ == null)
         {
            return null;
         }
         return new AvatarImage(_loc3_,var_29,param1,param2,AvatarType.const_95);
      }
      
      public function createPetImageNew(param1:int, param2:int, param3:uint, param4:String) : IAvatarImage
      {
         var _loc5_:String = var_1051.createAvatarFigureStringNew(param1,param2,param3);
      ...
      private function onComponentsRunning(param1:Event = null) : void
      {
         ...
         var_1051 = new PetDataManager(_loc2_,_loc4_);
         var_1304 = new PaletteManager(_loc2_,_loc4_);
         var _loc5_:XML = _assets.getAssetByName("HabboAvatarPetFigure").content as XML;
         var_1051.populateFigureData(_loc5_);
         _loc6_ = new AvatarStructure(this,assets,_loc2_,AvatarType.const_95);
         _loc6_.addEventListener(AvatarStructure.AVATAR_STRUCTURE_INIT,onStructureInit);
         var_494.add(AvatarType.const_95,_loc6_);
      ...
      private function paletteTest() : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc1_:PaletteMap = var_1304.getPalette(0);
