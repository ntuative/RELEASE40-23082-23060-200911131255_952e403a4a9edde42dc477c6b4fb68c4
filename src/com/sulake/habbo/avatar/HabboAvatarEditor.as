package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_870.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_871)
         {
            ...
            var_309 = new Map();
            var_309.add(AvatarEditorCategory.const_907,new GenericModel(this));
            var_309.add(AvatarEditorCategory.const_44,new HeadModel(this));
            var_309.add(AvatarEditorCategory.const_282,new TorsoModel(this));
            var_309.add(AvatarEditorCategory.const_1193,new LegsModel(this));
            var_309.add(AvatarEditorCategory.const_591,new WardrobeModel(this));
            var_871 = true;
         }
      }
      ...
      private function requestSavedOutfits() : void
      {
         ...
         var _loc1_:WardrobeModel = var_309.getValue(AvatarEditorCategory.const_591);
         if(_loc1_ != null)
         {
         }
      }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_309.getValue(AvatarEditorCategory.const_591);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_870.getPalette(param1);
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc7_ != null)
         {
            ...
            for each(_loc5_ in _loc7_.partSets)
            {
               _loc19_ = false;
               _loc20_ = true;
               if(_loc5_.gender == FigureData.const_1195)
               {
                  _loc19_ = true;
               }
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         else
         {
            if(var_354 == null)
            {
               var_354 = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_54,HabboWindowStyle.const_38,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
         ...
         _view.show();
         toggleAvatarEditorPage(AvatarEditorCategory.const_907);
         if(var_179 != null)
         {
            urlString = var_179.getKey("avatar.editor.url");
            try
            {
            }
            catch(e:Error)
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_1042 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
      ...
      private function onInventoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_28 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_539,onHabboClubChanged);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         var_870 = var_1042.getFigureData(AvatarType.const_95);
      }
