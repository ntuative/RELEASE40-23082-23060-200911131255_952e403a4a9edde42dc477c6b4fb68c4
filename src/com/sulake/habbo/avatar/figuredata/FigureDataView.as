package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureDataView
   {
      ...
      private var var_424:IBitmapWrapperWindow;
      ...
      public function FigureDataView(param1:IHabboWindowManager, param2:IAssetLibrary)
      {
         ...
         var_1256 = _loc4_.content as BitmapData;
         if(_window != null)
         {
            var_424 = _window.findChildByName("bitmap") as IBitmapWrapperWindow;
         }
      }
      ...
      {
         var_424.bitmap = new BitmapData(var_424.width,var_424.height,true,16777215);
         var_424.bitmap.copyPixels(var_1256,var_1256.rect,new Point(0,0 - 0 - 8));
         var_424.bitmap.copyPixels(param1,param1.rect,new Point(4,0),null,null,true);
      }
   }
}
