package com.sulake.habbo.avatar.head
{
   ...
   public class HeadView implements IAvatarEditorCategoryView
   {
      ...
      public function HeadView(param1:HeadModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_624["null"] = new AvatarEditorGridView(param1,FigureData.const_109,param2,param3);
         var_624["null"] = new AvatarEditorGridView(param1,FigureData.const_139,param2,param3);
         var_624["null"] = new AvatarEditorGridView(param1,FigureData.const_138,param2,param3);
         var_624["null"] = new AvatarEditorGridView(param1,FigureData.const_124,param2,param3);
         var_624["null"] = new AvatarEditorGridView(param1,FigureData.const_125,param2,param3);
         attachImages();
