package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_707:String = "InitConnection";
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_114.removeEventListener(SSOTicket.const_323,onParsedTicketSuccess);
         var_114.removeEventListener(SSOTicket.const_251,onParsedTicketFailure);
         var_114 = null;
         dispatchEvent(new Event(const_707));
      }
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1351,"/");
      ...
      private function createWindow() : void
      {
         ...
         _window = var_315.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_320,HabboWindowStyle.const_39,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(const_1351,"/");
         if(_loc5_ != null)
         {
      ...
      private function initSSOTicket() : void
      {
         ...
         var_114.addEventListener(SSOTicket.const_323,onParsedTicketSuccess);
         var_114.addEventListener(SSOTicket.const_251,onParsedTicketFailure);
      }
