package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_1554:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1303:ILogger;
      
      private var var_1050:String;
      
      private var var_1552:String;
      
      private const const_1351:String = "fuselogin";
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_309:
               ...
               break;
            case DisconnectReasonEvent.const_962:
               _loc3_ = _habboConfiguration.getKey("logout.concurrent.url");
               break;
            case DisconnectReasonEvent.const_808:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1553)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_579 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_579);
            _loc2_.send(_loc4_);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1050,var_1552));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1351,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_1554);
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1351,"/");
      ...
      {
         var_579 = _habboConfiguration.getKey("sso.ticket",null);
         var_1050 = _habboConfiguration.getKey("flash.client.url","");
         var_1552 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_163 == null)
         {
         ...
         if(var_579 != null)
         {
            var_75.mode = HabboConnectionType.const_356;
            var_75.initConnection(HabboConnectionType.const_248);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1303 = param2 as ILogger;
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_655);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_1554 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_75.mode)
         {
            case HabboConnectionType.const_356:
               _loc6_ = "";
               ...
               var_881 = _loc4_;
               var_163.loadBannerImage(_loc7_ + "?token=" + var_881,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1134:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1123:
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_34.events.addEventListener(RoomSessionEvent.const_90,onRoomSessionEnded);
      }
