package com.sulake.habbo.room
{
   ...
   public class RoomMessageHandler
   {
      ...
      private function onParkBusDoor(param1:IMessageEvent) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.setNumber(RoomObjectVariableEnum.const_951,_loc3_.status);
         }
      }
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc6_ < _loc3_.getUserCount())
         {
            ...
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.webID == var_2080)
               {
                  var_24.method_11(_loc4_,_loc5_,_loc7_.id);
               }
            ...
            if(_loc2_.avatar != null)
            {
               ...
               switch(_loc9_.moveType)
               {
                  case SlideObjectMessageData.const_835:
                     _loc10_ = "mv";
                     break;
                  case SlideObjectMessageData.const_968:
                     _loc10_ = "std";
               }
