package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_737:String = "tile_cursor";
      
      private static const const_268:String = "RCL_PUBLICROOM_";
      
      private static const const_475:String = "wall_place_holder";
      
      private static const const_1015:int = 2;
      
      private static const const_333:String = "place_holder";
      
      private static const const_1016:String = const_333;
      ...
      public static const const_584:String = "RCL_LOADER_READY";
      ...
      private var var_916:IEventDispatcher = null;
      ...
      public function RoomContentLoader()
      {
         var_606 = [];
         var_607 = [];
         var_1711 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
      ...
      private function extractPublicRoomFromXML(param1:String, param2:XML) : PublicRoomData
      {
         ...
         while(_loc5_ < _loc3_.length())
         {
            ...
            _loc7_ = const_268 + String(_loc6_.@name);
            _loc8_ = 32;
            _loc9_ = 1;
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_108 || param1 == RoomObjectVisualizationEnum.PET || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      {
         if(var_164 != null && var_164.hasWorldType(const_268 + param1))
         {
            return var_164.type;
         }
         return param1;
                     ...
                     if(_loc8_.length > 0)
                     {
                        ...
                        if(_loc9_.length >= 3)
                        {
                           ...
                           if(_loc9_[0] as String == "s")
                           {
                              ...
                              if(var_606.indexOf(_loc14_) < 0)
                              {
                                 var_606.push(_loc14_);
                              }
                           }
                           else if(_loc9_[0] as String == "i")
                           {
                              ...
                              if(var_607.indexOf(_loc14_) < 0)
                              {
                                 var_607.push(_loc14_);
                              }
                           }
                           _loc16_ = var_447.getValue(_loc14_);
                           if(_loc12_ > _loc16_)
                           {
                              var_447.remove(_loc14_);
                              var_447.add(_loc14_,_loc12_);
                           }
                        }
                     }
                  }
      ...
      public function dispose() : void
      {
         ...
         if(var_365 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc3_ = var_365.getWithIndex(_loc2_) as AssetLibrary;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      {
         return [const_333,const_475,ROOM_CONTENT,const_737,const_736];
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = var_365.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = var_507.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = getContentType(_loc4_);
               _loc3_ = var_365.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE || _loc2_ == RoomObjectCategoryEnum.const_29)
         {
            ...
            return int(var_447.getValue(param1));
         }
         return 0;
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_1711.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_151 && _loc5_ != RoomObjectLogicEnum.const_108)
         {
            _loc6_ = "@shadow";
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,CoreComponent.const_1245);
               return;
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(var_1714)
         {
            ...
            if(var_916 != null)
            {
               var_916.dispatchEvent(new Event(const_584));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_164 != null)
         {
            return var_164.getWorldHeightScale(const_268 + param1);
         }
         return 1;
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            var_916 = param1;
            var_1716 = param2.getKey("flash.dynamic.download.url","furniture/");
            ...
            var_1710 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         _state = const_738;
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_151 && _loc5_ != RoomObjectVisualizationEnum.const_108)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      {
         if(getObjectCategory(const_268 + param1) == RoomObjectCategoryEnum.const_52)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_379,onContentLoaded);
            _loc6_ = 0;
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_164 != null)
         {
            return var_164.getWorldScale(const_268 + param1);
         }
         return 32;
      }
