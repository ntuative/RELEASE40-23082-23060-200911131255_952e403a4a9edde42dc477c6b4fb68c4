package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class Plane
   {
      ...
      public function createPlaneVisualization(param1:int, param2:int, param3:Number, param4:Number) : PlaneVisualization
      {
         ...
         var_383.add(String(param1),_loc5_);
         _sizes.push(param1);
         _sizes.sort();
         return _loc5_;
      }
      ...
      protected function getPlaneVisualization(param1:int) : PlaneVisualization
      {
         ...
         {
            var_646 = var_383.getValue(String(_sizes[_loc2_])) as PlaneVisualization;
         }
         else
         {
            var_646 = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_383 != null)
         {
            ...
            {
               _loc1_ = var_383.getWithIndex(_loc2_) as PlaneVisualization;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
