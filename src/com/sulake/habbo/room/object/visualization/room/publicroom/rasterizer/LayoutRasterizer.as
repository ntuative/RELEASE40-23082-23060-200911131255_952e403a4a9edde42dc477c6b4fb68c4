package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_433:Boolean = true;
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc11_:* = null;
         var_896 = param1;
         var _loc3_:LayoutRasterizerData = var_66.getValue(var_590);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              var_1074 = RoomObjectVariableEnum.const_883;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              var_1074 = RoomObjectVariableEnum.const_879;
                           }
                           if(param2 != null)
                           {
      ...
      public function showAd(param1:IRoomObjectSpriteVisualization, param2:String = "", param3:Boolean = false) : void
      {
         ...
         {
            exchangeElementGraphics("billboard_img",var_1074);
         }
         ...
         if(param3)
         {
            ...
            _loc5_.tag = RoomObjectVariableEnum.const_393;
         }
         if(param2 != "")
         {
            _loc4_.visible = true;
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(var_1641);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != var_590)
         {
            ...
            _adBgIndex = -1;
            _adImgIndex = -1;
            var_898 = var_66.getValue(var_590);
         }
      }
      ...
      {
         var _loc1_:LayoutRasterizerData = var_66.getValue(var_590);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(var_313.indexOf(_loc10_) >= 0 && var_433)
            {
               param1 = var_313.indexOf(_loc10_);
               if(true)
               {
                  _loc9_ = _assetCollection.getAsset(var_431[param1]);
                  if(_loc9_ != null)
                  {
                     param2.asset = _loc9_.asset;
                  }
               ...
               if(true)
               {
                  param2.alpha = var_432[param1];
               }
               var_313.splice(param1,1);
               var_431.splice(param1,1);
               var_432.splice(param1,1);
               if(false)
               {
                  var_433 = false;
               }
