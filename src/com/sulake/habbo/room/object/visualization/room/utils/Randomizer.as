package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1420:int = 16777216;
      
      public static const const_1533:int = 1;
       
      
      private var var_2209:int = 69069;
      
      private var var_1151:int = 1;
      
      private var var_2208:int = 5;
      
      private var var_1385:int = 16777216;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / var_1385 * param2);
      }
      ...
      {
         var _loc1_:int = var_2209 * var_1151 + var_2208;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
