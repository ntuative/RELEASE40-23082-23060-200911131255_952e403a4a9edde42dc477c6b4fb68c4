package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1164:int = 13421772;
      
      private static const const_1079:int = 16777215;
      
      public static const const_1293:int = 10066329;
      ...
      protected function updatePlanes(param1:IRoomGeometry) : void
      {
         ...
         while(_loc4_ < var_109.length)
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc5_)
               {
                  _loc9_.assetName = _loc6_ + "_" + var_1432;
               }
               if(var_83.getPlaneType(_loc4_) == RoomPlaneData.const_131)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < var_83.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_234)
            {
      ...
      protected function defineSprites() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            {
               if(_loc3_.type == RoomPlane.const_216 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
      ...
      override public function update(param1:IRoomGeometry = null) : void
      {
         ...
         {
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_564);
            _loc6_ = _loc3_.getString(RoomObjectVariableEnum.const_608);
            _loc7_ = _loc3_.getString(RoomObjectVariableEnum.const_611);
            updatePlaneTextureTypes(_loc6_,_loc5_,_loc7_);
            _loc8_ = _loc3_.getString(RoomObjectVariableEnum.const_946);
            if(_loc8_ != var_2061)
            {
               updatePlaneMasks(_loc8_);
               var_2061 = _loc8_;
            }
            _loc9_ = uint(_loc3_.getNumber(RoomObjectVariableEnum.const_577));
            if(_loc9_ != var_1004)
            {
               var_1004 = _loc9_;
            }
            var_2060 = Boolean(_loc3_.getNumber(RoomObjectVariableEnum.const_779));
         ...
         while(_loc4_ < var_109.length)
         {
            ...
            if(_loc10_ != null && _loc11_ != null && _loc11_.type != RoomPlane.const_176)
            {
               ...
               if(var_2060)
               {
                  _loc13_ = uint((_loc12_ & 255) * (var_1004 & 255) / 255);
                  _loc14_ = uint((_loc12_ >> 8 & 255) * (var_1004 >> 8 & 255) / 255);
                  _loc15_ = uint((_loc12_ >> 16 & 255) * (var_1004 >> 16 & 255) / 255);
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_934);
         var _loc7_:int = 0;
         while(_loc7_ < var_83.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_234)
            {
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < var_109.length)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               else if(_loc5_.type == RoomPlane.const_216 && param2 != null)
               {
                  _loc5_.id = param2;
               }
         ...
         while(_loc5_ < _planeMaskParser.maskCount)
         {
            ...
            if(_loc7_ != null)
            {
               ...
               while(_loc9_ < var_109.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_216 || _loc3_.type == RoomPlane.const_176 && _loc8_ == RoomPlaneBitmapMaskData.const_204)
                  {
