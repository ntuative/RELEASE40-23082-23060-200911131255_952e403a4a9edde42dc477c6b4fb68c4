package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1278:int = const_295;
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(var_1397 == const_94)
         {
            _loc5_ = new Rectangle(0,0,var_38.width,var_457);
         }
         else
         {
            _loc5_ = new Rectangle(0,0 - var_457,var_38.width,var_457);
         }
         ...
         if(isStatic)
         {
            if(var_38 != null)
            {
               if(var_38.width == param2 && var_38.height == param3 && Vector3d.isEqual(var_709,param4))
               {
                  if(param1 != null)
                  {
                     copyCachedBitmapOnCanvas(param1,var_457,param6,param7);
                     return param1;
                  }
                  return var_38;
               }
