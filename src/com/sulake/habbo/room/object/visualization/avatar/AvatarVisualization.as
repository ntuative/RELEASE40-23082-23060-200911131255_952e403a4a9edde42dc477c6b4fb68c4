package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private var var_733:AvatarVisualizationData = null;
      ...
      {
         var_733 = param1 as AvatarVisualizationData;
         createSprites(const_1017);
         return true;
      }
      ...
      override public function update(param1:IRoomGeometry = null) : void
      {
         ...
         var _loc9_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_673);
         var _loc10_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_649);
         ...
         var _loc13_:Number = _loc7_ - var_1248;
         ...
         var _loc15_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_306);
         if(_loc15_ > 0)
         {
         ...
         var _loc19_:Boolean = var_274 != _loc2_.getUpdateID() || var_207 != param1.scale || var_183 != _loc3_.getUpdateID();
         var _loc20_:Boolean = _isAnimating || var_478 > 0;
         if(_loc19_ || _loc20_)
         {
            --var_478;
            _loc22_ = getTimer();
            ...
            if(_loc5_ == null)
            {
               _loc5_ = var_733.getAvatar(_loc6_,param1.scale);
               if(_loc5_ == null)
               {
                  return;
               }
            ...
            _loc24_ = _loc3_.getNumber(RoomObjectVariableEnum.const_274);
            if(isNaN(_loc24_) || _loc3_.getString(RoomObjectVariableEnum.const_265) == "float")
            {
               _loc24_ = _loc23_;
            }
            else
            ...
            _loc25_ = _loc3_.getString(RoomObjectVariableEnum.const_265);
            _loc26_ = _loc3_.getString(RoomObjectVariableEnum.const_621);
            _loc5_.appendAction(AvatarAction.const_634,_loc25_,_loc26_);
            _loc27_ = false;
            if(_loc25_ == "lay")
            {
            ...
            _loc28_ = _loc3_.getNumber(RoomObjectVariableEnum.const_404);
            if(_loc28_ > 0 && _loc5_.getScale() == AvatarScaleType.const_50)
            {
               _loc50_ = _loc3_.getNumber(RoomObjectVariableEnum.const_369);
               _loc51_ = 3;
               _loc52_ = _loc7_ - _loc50_;
               if(_loc52_ < _loc51_ * 1000)
               {
                  _loc5_.appendAction(AvatarAction.const_277,AvatarAction.const_1098[_loc28_]);
               }
            }
            _loc29_ = _loc3_.getNumber(RoomObjectVariableEnum.const_884);
            if(_loc29_ > 0)
            {
               _loc5_.appendAction(AvatarAction.const_978,_loc29_);
            }
            _loc30_ = _loc3_.getNumber(RoomObjectVariableEnum.const_858);
            if(_loc30_ > 0)
            {
               _loc53_ = _loc3_.getNumber(RoomObjectVariableEnum.const_766);
               _loc54_ = 5;
               _loc55_ = _loc7_ - _loc53_;
               if(_loc55_ < _loc54_ * 1000)
               {
                  _loc5_.appendAction(AvatarAction.const_918,_loc30_);
               }
            }
            _loc31_ = _loc3_.getNumber(RoomObjectVariableEnum.const_706);
            _loc32_ = 0;
            if(_loc31_ > 0)
            {
               _loc56_ = _loc3_.getNumber(RoomObjectVariableEnum.const_603);
               _loc57_ = 100;
               _loc58_ = _loc7_ - _loc56_;
               if(_loc58_ < _loc57_ * 1000)
               {
                  _loc5_.appendAction(AvatarAction.const_777,_loc31_);
                  _loc59_ = 1;
                  while(_loc59_ < 10)
                  {
            ...
            _loc33_ = _loc3_.getNumber(RoomObjectVariableEnum.const_775);
            if(_loc32_ > 0)
            {
               _loc33_ = _loc32_;
            }
            if(_loc33_ > 0)
            {
               _loc5_.appendAction(AvatarAction.const_785,_loc33_);
            }
            if(_loc8_)
            {
            ...
            if(_loc34_ || _loc12_)
            {
               _loc5_.appendAction(AvatarAction.const_711);
            }
            if(_loc14_)
            {
               _loc5_.appendAction(AvatarAction.const_469);
            }
            _loc35_ = _loc3_.getNumber(RoomObjectVariableEnum.const_781);
            if(_loc35_ > 0)
            {
            ...
            if(_loc3_.getNumber(RoomObjectVariableEnum.const_773))
            {
               _loc42_.visible = true;
               _loc39_ = null;
               _loc38_ = null;
               ...
               if(_loc38_ != null)
               {
                  _loc39_ = var_733.getAvatarRendererAsset(_loc38_) as BitmapDataAsset;
               }
               if(_loc39_ != null)
               {
                  _loc42_.asset = _loc39_;
            ...
            var_734.push(getTimer() - _loc22_);
            if(false)
            {
               _loc76_ = 0;
               _loc77_ = "[";
               for each(_loc78_ in var_734)
               {
                  _loc76_ += _loc78_;
                  _loc77_ += "," + _loc78_;
               }
