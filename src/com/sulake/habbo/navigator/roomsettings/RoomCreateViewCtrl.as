package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_793:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_1183 = new Timer(100);
         var_1183.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_66 = new Array();
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         var_1896 = _navigator.data.hcMember;
      }
      ...
      private function refresh() : void
      {
         ...
         var_793 = var_66[0];
         if(var_1896 != _navigator.data.hcMember)
         {
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_54,HabboWindowStyle.const_38,HabboWindowParam.const_64,new Rectangle(0,0,100,300)));
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_793.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1182 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1182 = true;
            _loc3_.y = 1;
