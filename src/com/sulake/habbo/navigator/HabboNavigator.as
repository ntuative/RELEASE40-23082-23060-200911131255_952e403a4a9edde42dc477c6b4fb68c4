package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_2220:Dictionary;
      ...
      private var var_1634:ISessionDataManager;
      
      private var var_1632:RoomCreateViewCtrl;
      
      private var var_1631:RoomThumbnailRenderer;
      
      private var var_195:IHabboToolbar;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_1071:RoomInfoViewCtrl;
      
      private var var_84:IHabboCatalog;
      
      private var var_361:Tabs;
      
      private var var_427:MainViewCtrl;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_427 = new MainViewCtrl(this);
         var_1071 = new RoomInfoViewCtrl(this);
         var_1632 = new RoomCreateViewCtrl(this);
         var_1631 = new RoomThumbnailRenderer(this);
         var_909 = new GuestRoomPasswordInput(this);
         var_325 = new GuestRoomDoorbell(this);
         var_361 = new Tabs(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_427.startSearch(Tabs.const_187,Tabs.const_324,param1);
         var_427.mainWindow.activate();
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = var_179.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_195 != null)
         {
            var_195.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_113,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_195.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_113,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1634 = param2 as ISessionDataManager;
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_427.startSearch(Tabs.const_255,Tabs.const_208);
         var_361.getTab(Tabs.const_255).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_427.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
