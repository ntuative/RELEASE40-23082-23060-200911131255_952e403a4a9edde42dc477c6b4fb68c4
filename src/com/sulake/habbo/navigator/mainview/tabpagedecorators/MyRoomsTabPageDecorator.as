package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_423:IDropMenuWindow;
      ...
      {
         var _loc1_:int = var_423 == null ? 0 : int(var_423.selection);
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_423 == null)
         {
            var_423 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            var_423.procedure = onChangeSubNavi;
            prepareSubNavi();
         }
         _loc3_.visible = true;
      }
