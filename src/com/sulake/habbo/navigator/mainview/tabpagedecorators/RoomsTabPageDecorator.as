package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_253,Tabs.const_280);
         }
         else if(_loc1_ == 1)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_253,Tabs.const_570);
         }
         else
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_253,Tabs.const_280,"" + _loc3_);
         }
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_428 == null)
         {
            var_428 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
            var_428.procedure = onChangeFilter;
