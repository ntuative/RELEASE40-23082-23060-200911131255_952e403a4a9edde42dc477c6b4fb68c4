package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      {
         setEnabled(_bgTabButton,this.var_91.mode != ThumbnailEditorModel.const_34);
         setEnabled(var_1463,this.var_91.mode != ThumbnailEditorModel.const_51);
         setEnabled(var_1462,this.var_91.mode != ThumbnailEditorModel.const_31);
      }
      ...
      private function onBgTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_91.mode = ThumbnailEditorModel.const_34;
         this.reload();
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1462 = IButtonWindow(find("obj_tab"));
         var_2038 = IWindowContainer(find("tile_grid"));
         var_2037 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1462,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_2038;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_403)
            {
      ...
      {
         var _loc1_:IWindowContainer = var_2037;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_54,HabboWindowStyle.const_38,HabboWindowParam.const_64,new Rectangle(0,0,param1.width,66)));
