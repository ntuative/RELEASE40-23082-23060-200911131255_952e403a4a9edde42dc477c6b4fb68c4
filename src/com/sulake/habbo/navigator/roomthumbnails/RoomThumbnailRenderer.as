package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      public static const const_403:int = 10;
      
      private static const const_1042:int = 40;
      ...
      private var var_768:ThumbnailImageConfigurations;
      
      private var var_1164:BitmapData;
      ...
      public function RoomThumbnailRenderer(param1:HabboNavigator)
      {
         ...
         super();
         _navigator = param1;
         var_768 = new ThumbnailImageConfigurations(_navigator);
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_768.getImage(ThumbnailEditorModel.const_31,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1041,_loc4_.y + const_1042 - _loc5_.height),null,null,true);
      }
      ...
      {
         return Point(this.var_1846[param1]);
      }
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_768.getImage(ThumbnailEditorModel.const_34,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_768.getImage(ThumbnailEditorModel.const_34,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_768.getImage(ThumbnailEditorModel.const_51,param2);
         if(_loc3_ == null)
         {
      ...
      private function getLoc(param1:int, param2:int) : Point
      {
         ...
         return new Point(param1 * const_747 + _loc3_,param2 * const_1040);
      }
      ...
      private function refreshObjects(param1:BitmapData, param2:Array) : void
      {
         ...
         while(_loc3_ <= const_403)
         {
            if(false)
            {
               refreshObj(param1,var_950[_loc3_]);
            }
            _loc3_++;
         }
      }
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         if(var_1164 == null)
         {
            var_1164 = _navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(var_1164,var_1164.rect,new Point(0,0),null,null,true);
      }
   }
}
