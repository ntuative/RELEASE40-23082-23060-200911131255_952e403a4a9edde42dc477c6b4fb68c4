package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         var_1631 = new RoomThumbnailRenderer(param1);
         var_900 = new TagRenderer(param1,hideInstantly);
      }
      
      private function refreshOwnerName() : void
      {
         refreshTextWithCaption("roomowner",var_168,var_117.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         var_900.refreshTags(_loc1_,var_117.tags);
         refreshTextWithCaption("rating",_loc1_,"undefined");
         if(false)
         {
            refreshTextWithCaption("startedat",_loc1_,"undefined");
         }
         var_1631.refreshThumbnail(_loc1_,var_117.thumbnail,false);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         refreshRoomName(var_168,var_117);
         if(true)
         {
         }
         refreshOwnerName();
         refreshTextWithCaption("roomctg",var_168,!true ? getEventCtg(var_117.categoryId) : getRoomCtg(var_117.categoryId));
         refreshRoomDesc(var_168,var_117);
         refreshExtraCont();
         refreshInfo(var_168,"trading_allowed",var_117.allowTrading);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_187,Tabs.const_189,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
