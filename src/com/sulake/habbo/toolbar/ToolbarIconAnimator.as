package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         var_700 = new Array();
         _state = param1.id;
         var_1060 = param1.nextState;
         var_1062 = param1.loop;
         if(param1.background != null)
         {
            var_701 = getBitmapDataFromAsset(param1.background,param2);
         }
         ...
         else
         {
            ...
            if(_loc8_ != null)
            {
               var_702.push(new XML());
               var_700.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            var_700[var_55] = param6.clone();
         }
      ...
      {
         if(var_1062 == true || var_583 == 0)
         {
            if(false)
            {
               ++var_55;
               if(var_55 >= var_702.length)
               {
                  var_55 = 0;
                  ++var_583;
               }
      ...
      {
         return var_702.length;
      }
      
      public function hasNextState() : Boolean
      {
         return var_1062 == false && var_583 == 1 && var_1060 != _state;
      }
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         if(var_701 != null)
         {
            _loc3_ = new BitmapData(Math.max(param2.width,var_701.width),Math.max(param2.height,var_701.height));
            _loc3_.copyPixels(var_701,var_701.rect,new Point(0,0));
      ...
      {
         var _loc2_:* = null;
         if(var_55 <= var_700.length)
         {
            _loc2_ = var_700[var_55];
