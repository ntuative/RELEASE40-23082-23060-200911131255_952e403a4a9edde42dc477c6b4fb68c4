package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1002:Number = 90;
      
      private static const const_753:int = 50;
      
      private static const const_1003:Number = 25;
      
      private static const const_1065:int = 50;
      ...
      private var var_970:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_970 = param2;
         var_541 = new Timer(const_1003);
         var_541.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = var_463.indexOf(param2);
         if(_loc3_ > -1)
         {
            var_463.splice(_loc3_,1);
            var_464.splice(_loc3_,1);
         }
         var_464.push(param1.name);
         var_463.push(param2);
      ...
      {
         return var_463[var_464.indexOf(param1)];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_970.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      {
         var _loc2_:Point = var_970.getIconLoc(param1.iconId);
      ...
      {
         return var_464[var_463.indexOf(param1)];
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_540[_loc3_] = new Array();
            }
            if(var_540[_loc3_].indexOf(param1) < 0)
            {
               var_540[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_753 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_753 || param1.desktop.height - param1.y < const_1065;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(var_464[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_540[_loc3_].length)
                  {
                     repositionWindow(var_540[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
