package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_619,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_890,onHideWindowEvent);
         _state = true;
