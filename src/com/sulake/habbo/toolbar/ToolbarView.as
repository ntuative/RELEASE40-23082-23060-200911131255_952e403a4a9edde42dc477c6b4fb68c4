package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_194 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_54,HabboWindowStyle.const_793,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_939 = String(_loc7_.relocate_by_drag.@state) == "true";
         if(var_939)
         {
         ...
         var_1145 = _loc7_.toolbar.@margin_bottom;
         var_1380 = _loc7_.toolbar.@min_group_margin;
         var_1379 = _loc7_.toolbar.@margin_to_extrabar;
         var_327 = new ToolbarBarMenuAnimator(param1,this);
         var _loc8_:XMLList = XMLList(_loc7_.toolbar).children();
         var _loc9_:XMLList = XMLList(_loc7_.extras).children();
         createGroupsFromXmlList(_loc8_,var_253,param1,param2,_window,var_327);
         createGroupsFromXmlList(_loc9_,var_522,param1,param2,var_194,var_327);
         alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,var_136,var_453,param3);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1380,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1145) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1380,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1145) / -1));
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,var_136,var_453);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,var_136,var_453);
         }
      }
