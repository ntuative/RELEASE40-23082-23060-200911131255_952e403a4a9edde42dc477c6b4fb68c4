package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1423:IIssueBrowserView;
      
      private const const_1566:String = "open_issues";
      
      private var _window:IFrameWindow;
      
      private const const_1567:String = "picked_issues";
      
      private var _assets:IAssetLibrary;
      
      private var var_1424:IIssueBrowserView;
      
      private const const_1572:String = "closed_issues";
      
      private var _issueManager:IssueManager;
      
      private const const_1568:String = "my_issues";
      ...
      private var var_328:IIssueBrowserView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_328.view.width = var_224.container.width;
         var_328.view.height = var_224.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1568:
               if(var_1424 == null)
               {
                  var_1424 = new MyIssuesView(issueManager,this,var_224.container);
               }
               return var_1424;
            case const_1566:
               if(var_1423 == null)
               {
                  var_1423 = new OpenIssuesView(issueManager,this,var_224.container);
               }
               return var_1423;
            case const_1567:
               if(var_1422 == null)
               {
                  var_1422 = new PickedIssuesView(issueManager,this,var_224.container);
               }
               return var_1422;
            default:
               return null;
