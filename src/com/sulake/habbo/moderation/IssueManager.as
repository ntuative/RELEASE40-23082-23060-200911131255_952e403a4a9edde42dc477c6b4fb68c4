package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_517:String = "issue_bundle_my";
      
      public static const const_802:String = "issue_bundle_picked";
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         var_139 = new Map();
         var_790 = new Map();
         var_536 = new IssueBrowser(this,var_64.windowManager,var_64.assets);
         var_645 = [];
         var_791 = [];
         var_961 = new Map();
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(var_790.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  var_790.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1269)
         {
            var_152.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in var_139)
            {
               if(validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  var_790.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            ...
            var_790.add(param1.issueId,_loc2_);
         ...
         if(param1.state == IssueMessageData.const_141)
         {
            ...
            _loc8_ = var_791.indexOf(param1.issueId);
            if(_loc8_ == -1 && _loc6_)
            {
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(var_536 == null || !var_536.isOpen())
         {
            var_64.soundManager.playSound(HabboSoundTypesEnum.const_865);
         }
      }
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = var_790.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = var_139.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
