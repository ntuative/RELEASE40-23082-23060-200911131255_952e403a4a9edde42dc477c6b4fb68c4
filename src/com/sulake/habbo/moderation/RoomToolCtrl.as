package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_889:ICheckBoxWindow;
      ...
      private var var_584:ICheckBoxWindow;
      
      private var var_55:IFrameWindow;
      
      private var var_890:ICheckBoxWindow;
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_53.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),var_53,WindowTracker.const_661,_data.flatId),var_55,false,false,true);
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + var_364);
         if(param1.flatId != var_364)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + var_364);
            return;
         }
         _data = param1;
         populate();
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = determineAction(param1,var_584.isSelected);
         var_53.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1137,_loc2_,var_386.text,"",""));
         if(false)
         {
            var_53.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_889.isSelected,var_890.isSelected,var_584.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1239);
         }
      ...
      public function populate() : void
      {
         ...
         var_584 = ICheckBoxWindow(var_55.findChildByName("kick_check"));
         var_889 = ICheckBoxWindow(var_55.findChildByName("lock_check"));
         var_890 = ICheckBoxWindow(var_55.findChildByName("changename_check"));
      ...
      public function show() : void
      {
         ...
         var_53.connection.send(new GetModeratorRoomInfoMessageComposer(var_364));
         Logger.log("BEGINNING TO SHOW: " + var_364);
      }
   }
}
