package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private function createView() : void
      {
         ...
         var_399 = new UserInfoCtrl(_window,var_64);
         var_999 = new UserInfoCtrl(_window,var_64);
         var_399.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_160.getHighestPriorityIssue().reporterUserId);
         var _loc3_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_999.load(_loc3_,var_160.reportedUserId);
         }
         else
         {
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var_64.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_64,WindowTracker.const_857,_loc2_),_window,false,false,true);
      }
      ...
      {
         return WindowTracker.const_1259;
      }
   }
}
