package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_748:int = 100;
       
      
      private var var_1867:IScrollbarWindow;
      
      private var var_134:HabboMessenger;
      
      private var var_1396:IContainerButtonWindow;
      
      private var var_456:Conversation;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         var_134 = param1;
         var_1396 = initButton("follow_friend",onFollowButtonClick,param2);
         _list = IItemListWindow(param2.findChildByName("msg_list"));
         var_1867 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_550 || param3.type == Message.const_542 ? param3.time + ": " : "";
      ...
      private function refreshList() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,var_456.messages.length - const_748);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < var_456.messages.length)
         {
            refreshEntry(true,_loc1_,var_456.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      public function refresh() : void
      {
         ...
         if(var_456 == null || _loc1_.id != var_456.id)
         {
            var_456 = _loc1_;
            refreshList();
            afterResize();
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_748 + const_1044)
         {
            refreshList();
            afterResize();
         }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_134.send(new FollowFriendMessageComposer(var_456.id));
      }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1045;
         param1.invalidate();
      }
   }
}
