package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, ICoreUpdateReceiver, IWindowContextStateListener
   {
      ...
      private var var_1221:ProfilerAgentTask;
      
      private var var_1223:IEventDispatcher;
      
      private var var_2235:uint = 0;
      
      private var var_1222:ProfilerAgentTask;
      
      private var var_1224:ProfilerOutput;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(param1 is CoreComponent)
         {
            ...
            _instance = this;
            var_1223 = Component(param1).events;
            var_821 = new Array();
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_296 = new Array(const_335);
         var _loc6_:int = 0;
         while(_loc6_ < const_335)
         {
            _loc5_ = new WindowContext("layer_" + _loc6_,var_673,this,_localization,var_185,new Rectangle(0,0,var_185.stageWidth,var_185.stageHeight),this);
            var_296[_loc6_] = _loc5_;
            _loc6_++;
         }
         var_354 = var_296[const_1071];
         registerUpdateReceiver(this,0);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         var_354.getMouseCursor().defineCustomCursorType(MouseCursorType.const_316,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         var_354.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1270,_loc7_);
      }
      ...
      {
         return var_296[param1].getDesktopWindow().getChildAt(var_354.getDesktopWindow().numChildren - 1);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1224 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1224 = new ProfilerOutput(_loc3_,this,var_673);
               var_1221 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1221);
               var_1222 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1222);
               var_988 = true;
            }
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            var_1223.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_335 - 1;
            while(_loc2_ >= 0)
            {
         ...
         var_1223.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         ...
         var_1223.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      
      public function getLayoutByType(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = var_821[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_821[0][param1] as XML : _loc4_;
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            if(param1 == MouseEvent.CLICK)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1170,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1109,param2.name + ": " + param2.toString());
            }
         }
      }
   }
