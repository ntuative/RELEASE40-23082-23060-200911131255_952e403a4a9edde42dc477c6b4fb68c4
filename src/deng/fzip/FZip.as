package deng.fzip
{
   ...
   public class FZip extends EventDispatcher
   {
      ...
      {
         return !!var_51 ? 0 : uint(0);
      }
      
      public function getFileAt(param1:uint) : FZipFile
      {
         return !!var_51 ? var_51[param1] as FZipFile : null;
      }
      ...
      protected function progressHandler(param1:Event) : void
      {
         ...
         {
            close();
            if(!hasEventListener(FZipErrorEvent.const_689))
            {
               throw e;
            }
            dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_689,e.message));
         }
      }
      ...
      public function serialize(param1:IDataOutput, param2:Boolean = false) : void
      {
         ...
         if(param1 != null && false)
         {
            ...
            _loc6_ = 0;
            _loc7_ = 0;
            while(_loc7_ < var_51.length)
            {
               _loc8_ = var_51[_loc7_] as FZipFile;
               if(_loc8_ != null)
               {
      ...
      public function loadBytes(param1:ByteArray) : void
      {
         if(!var_95 && parseFunc == parseIdle)
         {
            ...
            {
               dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_689,"EOF"));
            }
         }
      }
      ...
      private function parseLocalfile(param1:IDataInput) : Boolean
      {
         if(var_434.parse(param1))
         {
            ...
            if(false)
            {
               var_127["null"] = var_434;
            }
            dispatchEvent(new FZipEvent(FZipEvent.const_1233,var_434));
            var_434 = null;
      ...
      {
         var _loc2_:* = null;
         if(var_51 != null && var_127 != null && param1 < var_51.length)
         {
            _loc2_ = var_51[param1] as FZipFile;
            if(_loc2_ != null)
            {
      ...
      {
         return addFileAt(!!var_51 ? 0 : uint(0),param1,param2);
      }
      
      public function addFileFromString(param1:String, param2:String, param3:String = "utf-8") : FZipFile
      {
         return addFileFromStringAt(!!var_51 ? 0 : uint(0),param1,param2,param3);
      }
   }
}
